...
const texts: Text[] = [
  ...
  // Seatbelt sign changes
  {
    ...
    "texts": [
      {
        "en": "Ladies and gentlemen, we are expecting some light turbulence. Please return to your seats and fasten your seat belts.",
        ...
        "ja": "皆様、今後は軽い乱気流が予想されます。席に戻り、シートベルトを締めてください。",
      ...
      },
      {
        ...
        "ja": "巡航高度での気流が不安定なため、シートベルト着用サインを作動させました。安全のため、追って通知があるまで着席したままシートベルトを締めてください。",
      ...
      },
      {
        ...
        "ja": "こんにちは、機長です。巡航高度で気流が不安定なため、シートベルト着用サインを点灯しました。安全のため、追って通知があるまでシートベルトを締めてお座りください。",
    ...
    "texts": [
      {
        ...
        "ja": "皆様、私たちの船長から、今後軽い乱気流が予想されるとの連絡がありました。席にお戻りいただき、ベルト着用サインが消えるまでお座りください。現時点ではトイレの使用は禁止されています。",
      ...
      },
      {
        ...
        "ja": "船長から、この先軽い乱気流が予想されるとの連絡がありました。シートベルトを締めてください。",
      ...
      },
      {
        ...
        "ja": "船長から聞いた通り、今後は軽い乱気流が予想されます。席に戻り、シートベルトを締めてください。現時点ではトイレの使用は禁止されています。",
      ...
      },
      {
        ...
        "ja": "Ladies and gentlemen, the seat belt signs have been switched on. Please remain seated as much as possible. For safety reasons, our cabin crew will also minimize movement until the situation stabilizes.",
      ...
      },
      {
        ...
        "ja": "皆様の安全のため、シートベルト着用サインが点灯している間は機内を移動しないようお願いいたします。着席していない場合は、直ちにお席にお戻りください。",
      ...
      },
      {
        ...
        "ja": "皆様、シートベルト着用サインが点灯しました。飛行機に乗るのに慣れている方でも、この安全手順に従って着席したままでいてください。ご協力ありがとうございます。",
    ...
    "texts": [
      {
        ...
        "ja": "Ladies and gentlemen, the captain has switched on the seat belt signs. Please return to your seats and fasten your seat belts.",
      ...
      },
      {
        ...
        "ja": "皆様、シートベルト着用サインが点灯しました。お席にお戻りいただき、シートベルトをお締めください。現在、トイレのご利用はできません。",
      ...
      },
      {
        ...
        "th": "ท่านผู้โดยสารทุกท่าน สัญญาณรัดเข็มขัดที่นั่งเปิดอยู่  ขอความกรุณาทุกท่านนั่งประจำที่  ในเวลานี้  ขอให้พนักงานบนเครื่องจำกัดการเคลื่อนไหวของตนเองให้น้อยลงจนกว่าส ภาพจะเสถียร",
        "zh": "女士们，先生们，安全带标志现在已经打开。我们要求您尽量保持就座。出于安全考虑，我们的机组人员也会尽量减少移动，直到条件稳定。",
        "ja": "皆様、シートベルト着用サインが点灯しました。できるだけ着席したままでお待ちください。また、安全上の理由により、状況が安定するまで客室乗務員も移動を最小限に抑えます。",
        "ar": "سيداتي وسادتي، إشارة حزام الأمان الآن مضاءة. نطلب منكم البقاء في مقاعدكم قدر الإمكان. لأسباب تتعلق بالسلامة، سيقوم طاقم الطائرة أيضًا بتقليل حركتهم حتى تستقر الظروف."
      },
      {
        "en": "Ladies and gentlemen, for everyone’s safety, we ask that you avoid moving around the cabin while the seatbelt sign is on. If you’re not seated, please return to your seat immediately.",
    ...
    "texts": [
      {
        ...
        "ja": "皆様、機長がシートベルト着用サインを消しました。機内を移動していただいて構いませんが、予期せぬ乱気流に備えて、着席中はシートベルトを締めておくことをお勧めします。",
      ...
      },
      {
        ...
        "ja": "ご覧のとおり、シートベルト着用サインは消灯しています。機内を移動することは可能ですが、予期せぬ乱気流が発生した場合に備えて、着席中はシートベルトを締めておくことをお勧めします。",
      ...
      },
      {
        ...
        "ja": "シートベルト着用サインが消えました。機内を移動できます。予期せぬ乱気流に備えて、着席中はシートベルトを締めておくことをお勧めします。",
    ...
    "texts": [
      {
        ...
        "ja": "みなさん、こんにちは。現在、遅延が発生しています。ご不便をおかけして申し訳ございませんが、進捗状況については随時お知らせいたします。できるだけ早く目的地に到着できるよう全力で取り組んでおりますので、今しばらくお待ちください。",
      ...
      },
      {
        ...
        "ja": "こんにちは。機長です。現在、遅延が発生しています。ご不便をおかけして申し訳ございませんが、進捗状況については随時お知らせいたします。ご理解とご協力をよろしくお願いいたします。",
    ...
    "texts": [
      {
        ...
        "ja": "遅延について再度お詫び申し上げます。快適なフライトをお楽しみいただき、またのお越しをお待ちしております。",
    ...
    "texts": [
      {
        ...
        "pl": "Kapitanie, rozpoczęliśmy przyjmowanie pasażerów na pokład.",
  ...
  // Pre-flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "ja": "[Ladies and gentlemen, welcome onboard {airlineName} flight from {originCityName} to {destinationCityName}.] 私の名前は {captainName} で、このフライトの機長です。現在出発準備を行っており、まもなく離陸する予定です。 [Thank you for choosing {airlineName}.] フライトをお楽しみください。",
      ...
      },
      {
        ...
        "pl": "{% ['Dzień dobry', 'Dzień dobry', 'Dobry wieczór'][departureDayPhase]='Dzień dobry' %}, tu kapitan. Nazywam się {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Obecnie przygotowujemy się do startu i wkrótce rozpoczniemy kołowanie. Dziękujemy za wybór naszego przewoźnika.",
        "de": "{% ['Guten Abend', 'Guten Tag', 'Guten Abend'][departureDayPhase]='Hello' %}, hier spricht Ihr Kapitän. Mein Name ist {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Vielen Dank, dass Sie sich entschieden haben, heute mit uns zu fliegen.",
        "pt_br": "{% ['Bom dia', 'Boa tarde', 'Boa noite'][departureDayPhase]='Olá' %} aqui é o comandante falando. Eu me chamo {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] No momento estamos nos preparando para a partida e decolaremos em breve. Obrigado por escolher voar conosco hoje.",
        "es": "{% ['Buenos días', 'Buenas tardes', 'Buenas noches'][departureDayPhase]='Hola' %}, este es el capitán. Mi nombre es {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Actualmente nos estamos preparando para el despegue y pronto comenzaremos a rodar. Gracias por elegir nuestro transportista.",
        "fr": "{% ['Bonjour', 'Bonjour', 'Bonsoir'][departureDayPhase]='Bonjour' %}, ici votre commandant de bord. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Nous sommes en train de finaliser les préparatifs pour le départ et nous allons bientôt nous envoler. Merci d'avoir choisi de voyager avec nous aujourd'hui.",
        "it": "{% ['Buongiorno', 'Buon pomeriggio', 'Buonasera'][departureDayPhase]='Buongiorno' %}, parla il vostro commandante. Mi chiamo {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Stiamo finendo i preparativi per la partenza e decolleremo a breve. Grazie per aver scelto di volare con noi.",
        "tr": "{% ['Günaydın', 'İyi günler', 'İyi akşamlar'][departureDayPhase]='Merhaba' %}, kaptanınız konuşuyor. Adım {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Şu anda kalkışa hazırlanıyoruz ve kısa süre sonra yola çıkacağız. Bugün bizimle uçmayı seçtiğiniz için teşekkür ederiz.",
        "nl": "{% ['Goedemorgen', 'Goedemiddag', 'Goedenavond'][departureDayPhase]='Hallo' %}, hier spreekt uw gezagvoerder. Mijn naam is {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Wij bereiden ons momenteel voor op vertrek en zullen binnenkort opstijgen. Bedankt dat u heeft gekozen om vandaag met ons te vliegen.",
        "ko": "안녕하세요, 기장님입니다. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] 현재 출발 준비 중이며 곧 이륙할 예정입니다. 오늘 저희 비행기를 이용해 주셔서 감사합니다.",
        "pt_pt": "Caros passageiros, fala o vosso comandante. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] O meu nome é {captainName}. Estamos atualmente a preparar-nos para a descolagem e partiremos em breve. Obrigado por terem escolhido voar connosco hoje.",
        "no": "{% ['God morgen', 'God ettermiddag', 'God kveld'][departureDayPhase]='Hei' %}, dette er kapteinen som snakker. Jeg heter {captainName}. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Vi er for øyeblikket i ferd med å forberede oss til avgang, og forventer å sette i gang straks. Takk for at dere valgte å fly med oss i dag.",
        ...
        "zh": "女士们，先生们，我是您的机长。[Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] 我是 {captainName}. 我们正在准备起飞，稍后即将起飞。感谢您今天选择与我们一同飞行。",
        "ja": "{% ['おはようございます', 'こんにちは', 'こんばんは'][departureDayPhase]='こんにちは' %},これはあなたの船長が話しています。 [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] 現在出発準備を行っており、まもなく離陸する予定です。本日は当社のご利用をお選びいただきありがとうございます。",
      ...
      },
      {
        ...
        "ja": "{% ['おはようございます', 'こんにちは', 'こんばんは'][departureDayPhase]='こんにちは' %},これはあなたの船長が話しています。この {aircraftName} 航空機へようこそ。[This is {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] 現在出発準備を行っており、まもなく離陸する予定です。本日は当社のご利用をお選びいただきありがとうございます。",
      ...
      },
      {
        ...
        "ja": "{% ['おはようございます', 'こんにちは', 'こんばんは'][departureDayPhase]='こんにちは' %}, これはあなたの船長が話しています。 [On behalf of {airlineName} I would like to welcome you on board our {aircraftName} aircraft.] [Today we're flying from {originCityName} to {destinationCityName}.] 現在出発準備を行っており、まもなく離陸する予定です。本日は当社のご搭乗をご選択いただき、誠にありがとうございます。",
    ...
    "texts": [
      {
        ...
        "ja": "こんにちは、ご搭乗ありがとうございます。私の名前は {crewName} で、このフライトの客室乗務員です。機長からお聞きのとおり、現在出発準備中で、まもなく離陸します。シートベルトが締められ、シートの背もたれとトレイ テーブルが直立していることを確認してください。ノートパソコンや携帯電話を含むすべての個人用電子機器の電源をお切りください。フライト中は喫煙は禁止されています。ご質問やサポートが必要な場合は、私または同僚に遠慮なくお尋ねください。",
      ...
      },
      {
        ...
        "ja": "皆様、ご搭乗ありがとうございます。私の名前は {crewName} で、このフライトの客室乗務員です。シートベルトをお締めいただき、すべての手荷物を座席の下または頭上の収納スペースに固定してください。また、離陸時には座席とテーブルトレイを直立させてください。ノートパソコンや携帯電話を含むすべての個人用電子機器の電源をお切りください。フライト中は喫煙は禁止されています。[Thank you for choosing {airlineName}.] フライトをお楽しみください。",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, witamy na pokładzie. Nazywam się {crewName} i jestem jednym z członków personelu pokładowego. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Uprzejmie prosimy o bezpieczne schowanie bagażu podręcznego w schowkach nad siedzeniem lub pod siedzeniem przed Państwem i zapięcie pasów bezpieczeństwa. Prosimy upewnić się, że siedzenie jest w pozycji pionowej, a stolik jest schowany. Mamy nadzieję, że lot z nami będzie dla Państwa przyjemny. [Thank you for choosing {airlineName}.]",
        "de": "Sehr geehrte Damen und Herren, herzlich willkommen an Bord. Mein Name ist {crewName}, und ich bin heute eines Ihrer Kabinenbesatzungsmitglieder. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Bitte verstauen Sie Ihr Handgepäck sicher in den Gepäckfächern oder unter dem Sitz vor Ihnen und schließen Sie Ihren Sicherheitsgurt. Stellen Sie sicher, dass Ihr Sitz in der aufrechten Position ist und Ihr Klapptisch verstaut ist. Wir hoffen, dass Sie den Flug mit uns genießen. [Thank you for choosing {airlineName}.]",
        "pt_br": "Senhoras e senhores, sejam bem-vindos a bordo. Meu nome é {crewName} e sou um dos membros da tripulação hoje. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Solicitamos gentilmente que guardem seus pertences de mão com segurança nos compartimentos superiores ou debaixo do assento à sua frente e que afivelem os cintos de segurança. Certifiquem-se de que seus assentos estão na posição vertical e suas mesas dobráveis estão guardadas. Esperamos que aproveitem o voo conosco. [Thank you for choosing {airlineName}.]",
        "es": "Damas y caballeros, bienvenidos a bordo. Mi nombre es {crewName} y soy uno de los miembros de la tripulación en este vuelo. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Les pedimos que guarden su equipaje de mano de forma segura en los compartimentos superiores o debajo del asiento frente a ustedes y abrochen sus cinturones de seguridad. Por favor, asegúrense de que sus asientos estén en posición vertical y sus mesas plegables estén guardadas. Esperamos que disfruten del vuelo con nosotros. [Thank you for choosing {airlineName}.]",
        "fr": "Mesdames et messieurs, bienvenue à bord. Je m'appelle {crewName}, et je fais partie de l'équipage aujourd'hui. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Nous vous demandons de ranger vos bagages à main en toute sécurité dans les compartiments supérieurs ou sous le siège devant vous, et d'attacher votre ceinture de sécurité. Veuillez vous assurer que votre siège est en position verticale et que votre tablette est rangée. Nous espérons que vous apprécierez votre vol avec nous. [Thank you for choosing {airlineName}.]",
        "it": "Signore e signori, benvenuti a bordo. Mi chiamo {crewName} e faccio parte del personale di bordo di questo volo. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Vi preghiamo di riporre i vostri bagagli a mano in sicurezza nei compartimenti sopra di voi o sotto il sedile di fronte a voi e di allacciare le cinture di sicurezza. Assicuratevi che il vostro sedile sia in posizione verticale e che il tavolino sia riposto. Speriamo che il volo con noi sia di vostro gradimento. [Thank you for choosing {airlineName}.]",
        "tr": "Bayanlar ve baylar, uçağımıza hoş geldiniz. Benim adım {crewName}, ve bugün kabin ekibinizden biriyim. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] El bagajlarınızı baş üstü dolaplarına veya önünüzdeki koltuğun altına güvenli bir şekilde yerleştirmenizi ve emniyet kemerinizi takmanızı rica ediyoruz. Lütfen koltuğunuzun dik konumda olduğundan ve masanızın kapalı olduğundan emin olun. Uçuşun tadını çıkarmanızı dileriz. [Thank you for choosing {airlineName}.]",
        "nl": "Dames en heren, welkom aan boord. Mijn naam is {crewName} en ik ben vandaag een van uw cabin attendants. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Wij vragen u vriendelijk om uw handbagage veilig op te bergen in de bagagevakken boven u of onder de stoel voor u, en uw gordel vast te maken. Zorg ervoor dat uw stoel in de rechtopstaande positie staat en uw tafeltje is ingeklapt. We hopen dat u geniet van de vlucht met ons. [Thank you for choosing {airlineName}.]",
        "ko": "여러분, 안녕하세요. 탑승을 환영합니다. 제 이름은 {crewName}이며 오늘 탑승 승무원의 한 명입니다. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] 기내 반입 수하물을 머리 위 선반이나 앞좌석 아래에 안전하게 보관하시고, 안전벨트를 착용해 주시기 바랍니다. 좌석을 세운 상태로 유지하시고 테이블을 접어 주세요. 저희와 함께하는 비행을 즐기시기 바랍니다. [Thank you for choosing {airlineName}.]",
        "pt_pt": "Caros passageiros, sejam bem-vindos a bordo. Chamo-me {crewName} e sou um dos membros da tripulação neste voo. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Solicitamos que guardem a bagagem de mão nos compartimentos superiores ou debaixo do assento à vossa frente e que apertem os cintos de segurança. Certifiquem-se de que os assentos estão na posição vertical e as mesas arrumadas. Esperamos que apreciem o voo connosco. [Thank you for choosing {airlineName}.]",
        "no": "Mine damer og herrer, velkommen om bord. Mitt navn er {crewName}, og jeg er et av kabinbesetningsmedlemmene i dag. [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] Vi ber dere vennligst oppbevare håndbagasjen sikkert i hattehyllene eller under setet foran dere og feste sikkerhetsbeltet. Vennligst sørg for at setet er i oppreist stilling, og at bordet er ryddet. Vi håper dere nyter flyturen med oss. [Thank you for choosing {airlineName}.]",
        "th": "ท่านผู้โดยสารทุกท่าน, ขอต้อนรับทุกท่านสู่เที่ยวบินของเรา ดิฉันชื่อ {crewName} เป็นหนึ่งในพนักงานต้อนรับบนเครื่องบินวันนี้ [Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] โปรดจัดเก็บสัมภาระของท่านให้เรียบร้อยในช่องเก็บสัมภาระเหนือศีรษะหรือใต้ที่นั่งด้านหน้าของท่าน และคาดเข็มขัดนิรภัยให้เรียบร้อย กรุณาปรับที่นั่งให้อยู่ในตำแหน่งตั้งตรงและพับโต๊ะให้เรียบร้อย เราหวังว่าท่านจะมีความสุขกับการเดินทางครั้งนี้ [Thank you for choosing {airlineName}.]",
        "zh": "女士们，先生们，欢迎登机。我叫{crewName}，是今天的机组成员之一。[Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] 请您将随身行李妥善放置在头顶行李舱或前排座椅下，并系好安全带。请确保座椅靠背已竖直，折叠桌已收起。希望您享受这次飞行。 [Thank you for choosing {airlineName}.]",
        "ja": "皆様、ご搭乗ありがとうございます。本日、客室乗務員の 1 人を務める {crewName} と申します。[Our captain, {captainName}, and the rest of the crew are delighted to have you with us on this flight to {destinationCityName}.] 機内持ち込み手荷物は頭上の収納棚または前の座席の下に安全に収納し、シートベルトをお締めください。座席は直立した状態で、トレイ テーブルは収納されていることを確認してください。弊社のフライトをお楽しみいただければ幸いです。[Thank you for choosing {airlineName}.]",
      ...
      },
      {
        ...
        "pl": "{% ['Dzień dobry', 'Dzień dobry', 'Dobry wieczór'][departureDayPhase]='Dzień dobry' %}, panie i panowie, witamy na pokładzie. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Proszę poświęcić chwilę na właściwe umieszczenie bagażu podręcznego i upewnienie się, że pasy są zapięte. Jeśli potrzebują Państwo pomocy, proszę się zwrócić do jednego z członków załogi. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "de": "{% ['Guten Morgen', 'Guten Tag', 'Guten Abend'][departureDayPhase]='Guten Tag' %}, meine Damen und Herren, und herzlich willkommen an Bord. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Bitte nehmen Sie sich einen Moment Zeit, um Ihr Handgepäck richtig zu verstauen und sicherzustellen, dass Ihr Sicherheitsgurt angelegt ist. Wenn Sie Hilfe beim Einrichten benötigen, zögern Sie nicht, einen unserer Crew-Mitglieder anzusprechen. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "pt_br": "{% ['Bom dia', 'Boa tarde', 'Boa noite'][departureDayPhase]='Bom dia' %}, senhoras e senhores, e bem-vindos a bordo. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Por favor, reserve um momento para armazenar sua bagagem de mão corretamente e certifique-se de que o seu cinto de segurança esteja afivelado. Se precisar de ajuda para se acomodar, não hesite em pedir assistência a um dos membros da nossa tripulação. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "es": "{% ['Buenos días', 'Buenas tardes', 'Buenas noches'][departureDayPhase]='Buen día' %}, damas y caballeros, y bienvenidos a bordo. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Por favor, tómese un momento para guardar su equipaje de mano correctamente y asegurarse de que su cinturón de seguridad esté abrochado. Si necesita ayuda para acomodarse, no dude en pedir asistencia a uno de nuestros miembros de la tripulación. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "fr": "{% ['Bonjour', 'Bon après-midi', 'Bonsoir'][departureDayPhase]='Bonjour' %}, mesdames et messieurs, et bienvenue à bord. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Merci de prendre un moment pour ranger vos bagages à main correctement et vous assurer que votre ceinture de sécurité est attachée. Si vous avez besoin d'aide pour vous installer, n'hésitez pas à demander à un membre de notre équipage. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "it": "{% ['Buongiorno', 'Buon pomeriggio', 'Buona sera'][departureDayPhase]='Buongiorno' %}, signore e signori, e benvenuti a bordo. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Vi preghiamo di dedicare qualche minuto per riporre correttamente il vostro bagaglio a mano e assicurarvi che la cintura di sicurezza sia allacciata. Se avete bisogno di assistenza per sistemarvi, non esitate a chiedere a uno dei membri del nostro equipaggio. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "tr": "{% ['Günaydın', 'İyi öğleden sonralar', 'İyi akşamlar'][departureDayPhase]='İyi günler' %}, bayanlar ve baylar, uçağımıza hoş geldiniz. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Lütfen bagaçınızı doğru şekilde yerleştirmeniz ve emniyet kemerinizin bağlı olduğundan emin olmanız için bir dakikanızı ayırın. Eğer yerleşmenize yardımcı olmamızı isterseniz, lütfen ekibimizden birine başvurmaktan çekinmeyin. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "nl": "{% ['Goedemorgen', 'Goedemiddag', 'Goedenavond'][departureDayPhase]='Goedendag' %}, dames en heren, welkom aan boord. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Neem alstublieft even de tijd om uw handbagage goed op te bergen en ervoor te zorgen dat uw veiligheidsgordel is vastgemaakt. Als u hulp nodig heeft bij het inrichten, aarzel dan niet om een van onze crewleden om hulp te vragen. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "ko": "{% ['Good morning', 'Good afternoon', 'Good evening'][departureDayPhase]='Good day' %}, 승객 여러분, 비행기에 오신 것을 환영합니다. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] 좌석에 앉으신 후 손님께서는 가방을 제대로 보관하시고 안전벨트를 착용해 주세요. 편안하게 앉으시고 여유를 가지세요. 추가로 도움이 필요하시면 승무원에게 문의해 주세요. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "pt_pt": "{% ['Bom dia', 'Boa tarde', 'Boa noite'][departureDayPhase]='Bom dia' %}, senhoras e senhores, e bem-vindos a bordo. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Por favor, reserve um momento para armazenar a sua bagagem de mão corretamente e garantir que o seu cinto de segurança está afivelado. Se precisar de ajuda para se acomodar, não hesite em pedir assistência a um dos membros da nossa tripulação. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "no": "{% ['God morgen', 'God ettermiddag', 'God kveld'][departureDayPhase]='God dag' %}, mine damer og herrer, og velkommen ombord. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] Vennligst ta et øyeblikk for å oppbevare håndbagasjen riktig og forsikre deg om at setebeltet er festet. Hvis du trenger hjelp til å komme deg på plass, er det bare å spørre en av våre kabinbesetning. [Sit back, relax, and thank you for flying with {airlineName}.]",
        "th": "{% ['สวัสดีตอนเช้า', 'สวัสดีตอนบ่าย', 'สวัสดีตอนเย็น'][departureDayPhase]='สวัสดีค่ะ' %}, ท่านผู้โดยสารทุกท่าน ยินดีต้อนรับสู่การเดินทางของเรา. [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] กรุณาใช้เวลาในการจัดเก็บกระเป๋าเดินทางของท่านอย่างเหมาะสม และตรวจสอบให้แน่ใจว่าเข็มขัดนิรภัยของท่านได้รับการรัดอย่างถูกต้อง หากท่านต้องการความช่วยเหลือในการจัดที่นั่ง กรุณาติดต่อพนักงานของเรา [Sit back, relax, and thank you for flying with {airlineName}.]",
        "zh": "{% ['早安', '下午好', '晚上好'][departureDayPhase]='日安' %}, 女士們，先生們，歡迎登機。 [My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] 請花一點時間正確放置您的手提行李並確保安全帶已經繫好。如果您需要協助安頓下來，請隨時向我們的機組人員詢問。 [Sit back, relax, and thank you for flying with {airlineName}.]",
        "ja": "{% ['おはようございます', 'こんにちは', 'こんばんは'][departureDayPhase]='こんにちは' %}、皆様、ご搭乗ありがとうございます。[My name is {crewName}, and together with our captain, {captainName}, and the rest of the crew, I’ll ensure your journey to {destinationCityName} is a pleasant one.] お時間を取って機内持ち込み手荷物を適切に保管し、シートベルトが締められていることを確認してください。機内で落ち着くのにお手伝いが必要な場合は、乗務員に遠慮なくお尋ねください。ゆったりとおくつろぎください。 [Sit back, relax, and thank you for flying with {airlineName}.]",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, witamy na pokładzie! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Kiedy już Państwo się usadzą, prosimy upewnić się, że torby są bezpiecznie schowane, pasy są zapięte, a siedzenie jest w pozycji pionowej. Jeśli jest coś, co możemy zrobić, aby Państwa lot był bardziej komfortowy, nie wahajcie się nam powiedzieć. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "de": "Meine Damen und Herren, willkommen an Bord! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Wenn Sie sich eingerichtet haben, stellen Sie bitte sicher, dass Ihr Gepäck sicher verstaut ist, Ihr Sicherheitsgurt angelegt ist und Ihr Sitz in aufrechter Position ist. Wenn es etwas gibt, das wir tun können, um Ihren Flug komfortabler zu gestalten, lassen Sie es uns bitte wissen. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "pt_br": "Senhoras e senhores, bem-vindos a bordo! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Enquanto se acomodam, por favor, certifiquem-se de que suas bagagens estão bem guardadas, o cinto de segurança está afivelado e o assento está na posição vertical. Se houver algo que possamos fazer para tornar seu voo mais confortável, não hesite em nos avisar. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "es": "¡Damas y caballeros, bienvenidos a bordo! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Mientras se acomoden, asegúrense de que sus maletas estén guardadas de manera segura, su cinturón de seguridad esté abrochado y su asiento esté en posición vertical. Si hay algo que podamos hacer para que su vuelo sea más cómodo, no duden en informarnos. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "fr": "Mesdames et messieurs, bienvenue à bord ! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Lorsque vous vous installez, veuillez vous assurer que vos bagages sont correctement rangés, que votre ceinture de sécurité est attachée et que votre siège est en position verticale. Si nous pouvons faire quoi que ce soit pour rendre votre vol plus confortable, n’hésitez pas à nous le faire savoir. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "it": "Signore e signori, benvenuti a bordo! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Mentre vi sistemate, vi preghiamo di assicurarvi che le vostre borse siano correttamente riposte, che la cintura di sicurezza sia allacciata e che il vostro sedile sia in posizione verticale. Se c’è qualcosa che possiamo fare per rendere il vostro volo più comodo, non esitate a farcelo sapere. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "tr": "Bayanlar ve baylar, uçağımıza hoş geldiniz! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Yerleşirken, lütfen çantalarınızı güvenli bir şekilde yerleştirdiğinizden, emniyet kemerinizi taktığınızdan ve koltuğunuzun dik pozisyonda olduğundan emin olun. Uçuşunuzu daha konforlu hale getirebileceğimiz bir şey varsa, lütfen bize bildirin. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "nl": "Dames en heren, welkom aan boord! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Terwijl u zich installeert, zorg er dan voor dat uw bagage veilig is opgeruimd, uw veiligheidsgordel vastzit en uw stoel in de verticale positie staat. Als er iets is dat we kunnen doen om uw vlucht comfortabeler te maken, laat het ons dan weten. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "ko": "승객 여러분, 비행기에 오신 것을 환영합니다! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] 자리에 앉으신 후, 짐이 안전하게 보관되고 안전벨트가 착용되었으며, 좌석이 올바르게 조정되었는지 확인해 주세요. 만약 비행이 더 편안해지도록 할 수 있는 일이 있다면 언제든지 알려주세요. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "pt_pt": "Senhoras e senhores, bem-vindos a bordo! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] À medida que se acomodam, por favor, certifiquem-se de que as suas bagagens estão bem guardadas, o cinto de segurança está afivelado e o assento está em posição vertical. Se houver algo que possamos fazer para tornar o seu voo mais confortável, não hesite em nos avisar. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "no": "Mine damer og herrer, velkommen ombord! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] Når du har satt deg, vennligst sørg for at bagasjen er forsvarlig plassert, setebeltet er festet og setet er i oppreist posisjon. Hvis det er noe vi kan gjøre for å gjøre flyturen mer komfortabel, ikke nøl med å si ifra. [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "th": "ท่านผู้โดยสารทุกท่าน ยินดีต้อนรับสู่การเดินทางของเรา! [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] กรุณาใช้เวลาในการจัดเก็บกระเป๋าเดินทางของท่านอย่างเหมาะสม และตรวจสอบให้แน่ใจว่าเข็มขัดนิรภัยของท่านได้รับการรัดอย่างถูกต้อง เมื่อท่านจัดที่นั่งเสร็จเรียบร้อยแล้ว หากท่านต้องการความช่วยเหลือในการจัดที่นั่ง กรุณาติดต่อพนักงานของเรา [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "zh": "女士們，先生們，歡迎登機！ [My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] 請花一點時間正確放置您的手提行李並確保安全帶已經繫好。當您安頓好時，如果您需要任何協助，請隨時向我們的機組人員詢問。 [Thank you for flying with {airlineName}, and enjoy the journey.]",
        "ja": "皆様、ご搭乗ありがとうございます！[My name is {crewName}, and I’ll be looking after you today along with our captain, {captainName}, and the entire crew.] [We’re flying to {destinationCityName}, and we couldn’t be happier to have you with us.] 皆様がご搭乗くださることを心から嬉しく思っております。お着きになりましたら、お荷物が安全に収納されていること、シートベルトが締められていること、座席が直立していることをご確認ください。フライトをより快適にするために私たちができることがございましたら、遠慮なくお知らせください。[Thank you for flying with {airlineName}, and enjoy the journey.] 楽しい旅をお過ごしください。",
    ...
    "texts": [
      {
        ...
        "ja": "[Welcome aboard on this {airlineName} flight number {flightNumber}.] [Today we are flying from {originCityName} to {destinationCityName}.] 私の名前は {crewName} で、このフライトの客室乗務員です。現在出発の準備中で、まもなく離陸します。シートベルトが締められ、シートの背もたれとトレイ テーブルが直立していることを確認してください。ご質問やサポートが必要な場合は、遠慮なく私または同僚にお尋ねください。[Thank you for flying with {airlineName}.]",
      ...
      },
      {
        ...
        "ja": "[Ladies and gentlemen, welcome onboard {airlineName} flight from {originCityName} to {destinationCityName}.] 私の名前は{crewName}で、この便の客室乗務員です。シートベルトをお締めいただき、すべての手荷物を座席の下または頭上の収納スペースに固定してください。また、離陸時には座席とテーブルトレイを直立させてください。ノートパソコンや携帯電話を含むすべての個人用電子機器の電源をお切りください。飛行中は喫煙は禁止されています。[Thank you for flying with {airlineName}.] 楽しいフライトをお過ごしください。",
  ...
  // Basic information about the flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "de": "Hallo, ich bin es wieder. Ich dachte, ich teile einige Informationen mit Ihnen. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Wir erwarten einen ruhigen Flug. Bitte entspannen Sie sich und genießen Sie den Flug.",
        "pt_br": "Olá, sou eu de novo. Gostaria de compartilhar algumas informações com vocês. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.]  Esperamos um vôo tranquilo. Por favor, relaxe e aproveite o vôo.",
        "es": "Hola, soy yo de nuevo. Quería compartir algo de información contigo. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Esperamos un vuelo tranquilo. Que tengas un buen vuelo.",
        "fr": "Mesdames et messieurs, ici le commandant de bord. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Nous prévoyons un vol calme. Detendez-vous et profiter du vol.",
        "it": "Signore e signori, qui parla di nuovo il vostro comandante. Ecco alcune brevi informazioni sul nostro volo. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Si prevede un volo tranquillo. Buon volo.",
        "tr": "Merhaba, yine ben. Sizinle bazı bilgileri paylaşacağımı düşündüm. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Sorunsuz bir uçuş bekliyoruz. Lütfen rahatlayın ve uçuşun tadını çıkarın.",
        "nl": "Hallo, ik ben het weer. Ik dacht, laat ik wat informatie met jullie delen. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Wij verwachten een vlotte vlucht. Ontspan en geniet van de vlucht.",
        "ko": "안녕하세요. 다시 기장입니다. 승객 여러분들에게 몇가지 정보를 알려드릴까 합니다. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] 순조로운 비행이 되길 기대합니다. 긴장을 풀고 비행을 즐기시기 바랍니다.",
        ...
        "no": "Mine damer og herrer, dette er kapteinen som snakker igjen. [Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] Vi forventer en jevn flytur. Vennligst slapp av og nyt flyturen.",
        ...
        "zh": "[Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] 我们期望飞行能够非常顺利。请放松并享受旅程。",
        "ja": "[Our flight today will take approximately {flightTime}.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}.] フライトは順調に運航されるものと予想されます。どうぞリラックスしてフライトをお楽しみください。",
  ...
  },
  {
    ...
    "texts": [
      {
        "en": "Ladies and gentlemen, shortly after takeoff we'll start serving snacks and drinks. You can find our menu in the seat pocket in front of you.",
        ...
        "ja": "皆様、離陸後すぐに軽食とドリンクの提供を開始します。メニューは前方の座席ポケットにあります。",
      ...
      },
      {
        ...
        "ja": "離陸後すぐに軽食とドリンクの提供を開始します。メニューは前方の座席ポケットにあります。",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, wkrótce po starcie rozpoczniemy naszą obsługę pokładową, oferując wybór przekąsek i napojów. Nasze menu znajdą Państwo w kieszeni siedzenia przed sobą. Jeśli mają Państwo szczególne preferencje dietetyczne lub prośby, proszę nie wahać się poinformować jednego z członków naszej załogi. Dziękujemy.",
        "de": "Meine Damen und Herren, kurz nach dem Start beginnen wir mit unserem Bordservice, bei dem wir Ihnen eine Auswahl an Snacks und Getränken anbieten. Unser Menü finden Sie in der Sitztasche vor Ihnen. Wenn Sie spezielle diätetische Vorlieben oder Wünsche haben, zögern Sie bitte nicht, einem unserer Crewmitglieder Bescheid zu geben. Vielen Dank.",
        "pt_br": "Senhoras e senhores, logo após a decolagem, começaremos nosso serviço a bordo com uma seleção de lanches e bebidas. Você encontrará o nosso menu no bolso do assento à sua frente. Se tiver alguma preferência dietética específica ou algum pedido, por favor, não hesite em informar um dos nossos membros da equipe. Obrigado.",
        "es": "Damas y caballeros, poco después del despegue, comenzaremos nuestro servicio a bordo con una selección de bocadillos y bebidas. Encontrará nuestro menú en el bolsillo del asiento frente a usted. Si tiene alguna preferencia dietética o solicitud específica, no dude en informarle a uno de nuestros miembros de la tripulación. Gracias.",
        "fr": "Mesdames et messieurs, peu après le décollage, nous commencerons notre service à bord avec une sélection de snacks et de boissons. Vous trouverez notre menu dans la pochette du siège devant vous. Si vous avez des préférences alimentaires spécifiques ou des demandes, n’hésitez pas à en faire part à l’un de nos membres d’équipage. Merci.",
        "it": "Signore e signori, subito dopo il decollo inizieremo il nostro servizio a bordo con una selezione di snack e bevande. Troverete il nostro menu nella tasca del sedile di fronte a voi. Se avete preferenze alimentari particolari o richieste, non esitate a comunicarlo a uno dei membri del nostro equipaggio. Grazie.",
        "tr": "Bayanlar ve baylar, kalkıştan kısa bir süre sonra, ikramlarımızla başlayacağız ve size çeşitli atıştırmalıklar ve içecekler sunacağız. Menümüzü, önünüzdeki koltuk cebinde bulabilirsiniz. Belirli bir diyet tercihiniz veya isteğiniz varsa, lütfen ekibimizden birine bildirin. Teşekkür ederiz.",
        "nl": "Dames en heren, kort na het opstijgen beginnen we met onze service aan boord, met een selectie van snacks en drankjes. U vindt ons menu in de zitzak voor u. Als u specifieke dieetwensen of verzoeken heeft, aarzel dan niet om een van onze crewleden dit te laten weten. Dank u.",
        "ko": "승객 여러분, 이륙 직후, 간단한 스낵과 음료를 제공하는 기내 서비스를 시작하겠습니다. 메뉴는 앞 좌석의 주머니에 있습니다. 특별한 식이 선호나 요청 사항이 있으시면 언제든지 승무원에게 알려주세요. 감사합니다.",
        "pt_pt": "Senhoras e senhores, logo após a descolagem, começaremos o nosso serviço a bordo com uma seleção de snacks e bebidas. O nosso menu pode ser encontrado no bolso do assento à sua frente. Se tiver preferências alimentares específicas ou algum pedido, não hesite em informar um dos membros da nossa equipa. Obrigado.",
        "no": "Mine damer og herrer, kort tid etter takeoff starter vi vårt ombordservice med et utvalg av snacks og drikkevarer. Du finner menyen vår i setetasken foran deg. Hvis du har spesifikke kostholdsbehov eller ønsker, vennligst gi beskjed til et av våre mannskapsmedlemmer. Takk.",
        "th": "ท่านผู้โดยสารทุกท่าน, หลังจากที่เครื่องบินบินขึ้นไปไม่นาน เราจะเริ่มบริการบนเครื่องด้วยขนมและเครื่องดื่มท่านสามารถดูเมนูของเราได้จากกระเป๋าที่นั่งด้านหน้า หากท่านมีข้อกำหนดพิเศษเกี่ยวกับอาหารหรือต้องการอะไรเพิ่มเติม โปรดแจ้งให้พนักงานของเราทราบ ขอบคุณค่ะ",
        "zh": "女士们，先生们，起飞后不久，我们将开始提供机上服务，包括各类小吃和饮料。您可以在前排座椅的口袋里找到我们的菜单。如果您有任何特殊饮食要求或请求，请随时告知我们的机组人员。谢谢。",
        "ja": "皆様、離陸後すぐに機内サービスとして軽食とお飲み物をご用意いたします。メニューはお客様の前の座席ポケットにございます。特別な食事の好みやご要望がございましたら、遠慮なく乗務員にお知らせください。よろしくお願いいたします。",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, chcielibyśmy przypomnieć, że zakupy w strefie bezcłowej będą dostępne wkrótce po starcie. Znajdą Państwo katalog w kieszeni siedzenia przed sobą, prezentujący wybór ekskluzywnych produktów. Jeśli chcieliby Państwo dokonać zakupu, prosimy o przygotowanie płatności, a jeden z członków naszej załogi chętnie Państwu pomoże. Dziękujemy.",
        "de": "Meine Damen und Herren, wir möchten Sie daran erinnern, dass der Duty-Free-Shop kurz nach dem Start verfügbar sein wird. Sie finden einen Katalog in der Sitztasche vor Ihnen, der eine Auswahl exklusiver Produkte zeigt. Wenn Sie etwas kaufen möchten, halten Sie bitte Ihre Zahlungsmethode bereit, und ein Crew-Mitglied wird Ihnen behilflich sein. Vielen Dank.",
        "pt_br": "Senhoras e senhores, gostaríamos de lembrar que as compras duty-free estarão disponíveis logo após a decolagem. Você encontrará um catálogo no bolso do assento à sua frente, com uma seleção de produtos exclusivos. Caso deseje fazer uma compra, por favor, tenha o seu pagamento pronto, e um dos nossos membros da equipe o assistirá. Obrigado.",
        "es": "Damas y caballeros, nos gustaría recordarles que las compras libres de impuestos estarán disponibles poco después del despegue. Encontrará un catálogo en el bolsillo del asiento frente a usted, que muestra una selección de productos exclusivos. Si desea realizar una compra, tenga su forma de pago lista, y uno de nuestros miembros de la tripulación le asistirá. Gracias.",
        "fr": "Mesdames et messieurs, nous souhaitons vous rappeler que les achats hors taxes seront disponibles peu après le décollage. Vous trouverez un catalogue dans la pochette du siège devant vous, présentant une sélection de produits exclusifs. Si vous souhaitez faire un achat, veuillez préparer votre moyen de paiement, et un membre de notre équipage sera à votre disposition pour vous aider. Merci.",
        "it": "Signore e signori, desideriamo ricordarvi che lo shopping duty-free sarà disponibile subito dopo il decollo. Troverete un catalogo nella tasca del sedile di fronte a voi, con una selezione di prodotti esclusivi. Se desiderate fare un acquisto, preparate il pagamento e uno dei membri del nostro equipaggio sarà felice di assistervi. Grazie.",
        "tr": "Bayanlar ve baylar, kalkıştan kısa bir süre sonra, gümrüksüz alışveriş yapma imkanı sunulacaktır. Önünüzdeki koltuk cebinde, özel ürünlerin yer aldığı bir katalog bulabilirsiniz. Bir şey satın almak isterseniz, ödeme hazır olduğunda bir ekip üyemiz size yardımcı olacaktır. Teşekkür ederiz.",
        "nl": "Dames en heren, we willen u eraan herinneren dat duty-free winkelen kort na het opstijgen beschikbaar zal zijn. U vindt een catalogus in de zitzak voor u, waarin een selectie van exclusieve producten wordt getoond. Als u iets wilt kopen, houdt u dan uw betaling gereed en een van onze bemanningsleden helpt u graag. Dank u.",
        "ko": "승객 여러분, 이륙 직후 면세 쇼핑이 가능하다는 점을 알려드립니다. 앞 좌석 주머니에서 독점 제품을 소개하는 카탈로그를 확인하실 수 있습니다. 구매를 원하시면 결제 준비를 해 주시고, 승무원 중 한 명이 도와드리겠습니다. 감사합니다.",
        "pt_pt": "Senhoras e senhores, gostaríamos de lembrar que as compras duty-free estarão disponíveis logo após a descolagem. Encontrará um catálogo no bolso do assento à sua frente, com uma seleção de produtos exclusivos. Se desejar fazer uma compra, tenha o pagamento pronto e um dos nossos membros da equipa assistirá. Obrigado.",
        "no": "Mine damer og herrer, vi vil gjerne minne om at shopping i taxfree-butikken vil være tilgjengelig kort tid etter takeoff. Du finner en katalog i setetasken foran deg, med et utvalg av eksklusive produkter. Hvis du ønsker å kjøpe noe, vennligst ha betalingen klar, og et av våre mannskapsmedlemmer vil hjelpe deg. Takk.",
        "th": "ท่านผู้โดยสารทุกท่าน เราขอเตือนท่านว่า ท่านสามารถทำการช้อปปิ้งปลอดภาษีได้ในไม่ช้า หลังจากเครื่องบินบินขึ้นไปไม่นาน ท่านสามารถดูแคตตาล็อกของเราได้จากกระเป๋าที่นั่งด้านหน้า ซึ่งแสดงผลิตภัณฑ์พิเศษ หากท่านต้องการซื้อสินค้าใด ๆ กรุณาจัดเตรียมวิธีการชำระเงินและพนักงานของเราจะช่วยท่าน ขอบคุณค่ะ",
        "zh": "女士们，先生们，我们想提醒您，起飞后不久将会开放免税购物。您可以在前排座位的口袋里找到我们的产品目录，其中展示了精选的独家产品。如果您想购买，请准备好付款方式，我们的机组人员将为您提供帮助。谢谢。",
        "ja": "皆様、離陸後すぐに免税ショッピングがご利用可能になりますのでお知らせいたします。目の前の座席ポケットに、厳選された限定商品を紹介するカタログがあります。ご購入をご希望の場合は、代金をご用意ください。乗務員がお手伝いいたします。よろしくお願いいたします。",
    ...
    "texts": [
      {
        ...
        "ja": "[Our flight today will take approximately {flightTime}.] 機長からフライトは順調に運航するとの連絡がありました。離陸後すぐに軽食とドリンクの提供を開始します。スカイ メニューは前方の座席ポケットにあります。",
    ...
    "texts": [
      {
        ...
        "zh": "女士们，先生们，代表全体机组成员，我请您关注我们回顾的紧急情况程序。[There are {aircraftEmergencyExistsCount} emergency exits on this aircraft.] 请花点时间找出离您最近的出口。请注意，最近的出口可能在您的后方。如果机舱突然失压，请保持冷静并听从机组成员的指示。氧气面罩会从您的座位上方掉下来。将面罩罩住您的口鼻，如此操作。拉紧带子固定它。如果您与儿童同行，请先确保自己戴好面罩，再帮助您的孩子。在极少数紧急着陆和撤离的情况下，请放弃携带行李。救生筏位于您的座位下方，紧急照明将引导您到最近的出口。我们请您确保随身携带的行李在飞行过程中已妥善存放。在我们等待起飞时，请花几分钟时间阅读前方座椅口袋中的安全资料卡。感谢您的关注。",
        "ja": "皆様、緊急時の手順を確認している間、乗務員を代表して乗務員に注意を向けていただきますようお願いいたします。[There are {aircraftEmergencyExistsCount} emergency exits on this aircraft.] 1 分ほどお時間を取って、最寄りの出口を見つけてください。最寄りの出口は背後にある場合があります。客室の気圧が突然低下した場合は、落ち着いて客室乗務員の指示に耳を傾けてください。酸素マスクが座席の上から降りてきます。このようにマスクを口と鼻に当ててください。ストラップを引いて締めてください。お子様連れの場合は、お子様を助ける前に、まずご自身のマスクを装着してください。万が一、緊急着陸して避難しなければならない場合に備えて、機内持ち込み手荷物は置いてきてください。救命いかだは座席の下に設置されており、非常灯が最寄りの出口まで導いてくれます。飛行中は、機内持ち込み手荷物がすべて安全に収納されていることを確認してください。離陸を待つ間、少し時間を取って、前方の座席ポケットにある安全データ カードを確認してください。ご清聴ありがとうございました。",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, przygotowując się do odlotu, prosimy o pełną uwagę, podczas gdy przedstawimy najważniejsze informacje na temat bezpieczeństwa na pokładzie. W tym momencie należy zapiąć pasy bezpieczeństwa, a wszystkie przedmioty podręczne muszą zostać schowane w schowkach nad głową lub pod siedzeniem przed Państwem. W przypadku sytuacji awaryjnej prosimy o kierowanie się do wyjścia, które znajduje się najbliżej, podświetlonymi znakami. Pamiętajcie, że najbliższe wyjście może znajdować się za Państwem. W mało prawdopodobnym przypadku lądowania na wodzie, samolot jest wyposażony w kamizelki ratunkowe znajdujące się pod Państwa siedzeniem. Aby je założyć, wyciągnij kamizelkę, włóż ją przez głowę i zapnij paski. Aby napełnić kamizelkę, pociągnij za czerwone tabliczki lub dmuchaj w rurki po obu stronach. Nie nadmuchuj kamizelki, dopóki nie opuścisz samolotu. Jeśli maski tlenowe będą potrzebne, spadną automatycznie z panelu nad głową. Załóż maskę na nos i usta, zabezpiecz ją elastyczną opaską i oddychaj normalnie. Pomoc będzie udzielona, gdy wszyscy założą swoje maski. Dziękujemy za współpracę.",
        "de": "Meine Damen und Herren, während wir uns auf den Abflug vorbereiten, bitten wir Sie um Ihre volle Aufmerksamkeit, während wir die Sicherheitsmerkmale dieses Flugzeugs durchgehen. Die Sicherheitsgurte sollten jetzt angelegt werden, und alle Handgepäckstücke müssen in den Gepäckfächern über Ihrem Sitz oder unter dem Sitz vor Ihnen verstaut werden. Im Falle eines Notfalls folgen Sie bitte den beleuchteten Notausgangsschildern, um den nächsten Ausgang zu finden. Denken Sie daran, dass sich der nächste Ausgang hinter Ihnen befinden könnte. Im unwahrscheinlichen Fall einer Wasserlandung ist dieses Flugzeug mit Rettungswesten ausgestattet, die sich unter Ihrem Sitz befinden. Um die Weste zu verwenden, ziehen Sie sie heraus, ziehen Sie sie über den Kopf und sichern Sie sie mit den Riemen. Blasen Sie die Weste auf, indem Sie an den roten Laschen ziehen oder in die Rohre an beiden Seiten blasen. Blasen Sie die Weste nicht auf, bevor Sie das Flugzeug verlassen. Wenn Sauerstoffmasken benötigt werden, fallen diese automatisch vom Panel über Ihnen. Setzen Sie die Maske über Mund und Nase, sichern Sie sie mit dem Gummiband und atmen Sie normal. Unterstützung wird bereitgestellt, sobald jeder seine Maske trägt. Wir danken Ihnen für Ihre Zusammenarbeit, um Ihre Sicherheit und Ihren Komfort zu gewährleisten. Vielen Dank.",
        "pt_br": "Senhoras e senhores, enquanto nos preparamos para a decolagem, pedimos gentilmente a sua total atenção enquanto passamos pelas características de segurança desta aeronave. Os cintos de segurança devem estar afivelados neste momento, e todos os itens de mão devem ser armazenados nos compartimentos acima ou sob o assento à sua frente. Em caso de emergência, siga os sinais de saída iluminados para localizar a saída mais próxima. Lembre-se de que a saída mais próxima pode estar atrás de você. No improvável caso de um pouso na água, esta aeronave está equipada com coletes salva-vidas localizados sob o seu assento. Para usá-los, retire o colete, coloque-o sobre a cabeça e aperte as correias. Infle o colete puxando as abas vermelhas ou soprando nos tubos dos dois lados. Não infle o colete até sair da aeronave. Se as máscaras de oxigênio forem necessárias, elas cairão automaticamente do painel acima. Coloque a máscara sobre o nariz e a boca, prenda-a com a faixa elástica e respire normalmente. A assistência será fornecida assim que todos estiverem com suas máscaras. Agradecemos sua cooperação enquanto garantimos sua segurança e conforto. Obrigado.",
        "es": "Damas y caballeros, mientras nos preparamos para el despegue, les pedimos amablemente que presten atención mientras repasamos las características de seguridad de este avión. Los cinturones de seguridad deben estar abrochados en este momento, y todos los artículos de mano deben estar guardados en los compartimentos superiores o debajo del asiento frente a usted. En caso de emergencia, siga las señales de salida iluminadas para localizar la salida más cercana. Recuerde que su salida más cercana puede estar detrás de usted. En el poco probable caso de un aterrizaje en el agua, este avión está equipado con chalecos salvavidas ubicados debajo de su asiento. Para usarlos, saque el chaleco, póngalo sobre su cabeza y asegúrelo con las correas. Infle el chaleco tirando de las lengüetas rojas o soplando en los tubos a ambos lados. No infle el chaleco hasta que haya salido del avión. Si se necesitan máscaras de oxígeno, caerán automáticamente desde el panel superior. Coloque la máscara sobre su nariz y boca, asegúrela con la banda elástica y respire normalmente. Se proporcionará asistencia una vez que todos tengan puesta su máscara. Agradecemos su cooperación mientras garantizamos su seguridad y comodidad. Gracias.",
        "fr": "Mesdames et messieurs, alors que nous nous préparons pour le départ, nous vous demandons de bien vouloir prêter attention aux consignes de sécurité de cet avion. Les ceintures de sécurité doivent être attachées à ce moment, et tous les objets personnels doivent être rangés dans les compartiments supérieurs ou sous le siège devant vous. En cas d'urgence, suivez les panneaux de sortie éclairés pour localiser votre sortie la plus proche. N'oubliez pas que votre sortie la plus proche peut être derrière vous. En cas peu probable d'atterrissage sur l'eau, cet avion est équipé de gilets de sauvetage situés sous votre siège. Pour les utiliser, tirez le gilet, mettez-le par-dessus votre tête et attachez-le avec les sangles. Gonflez le gilet en tirant sur les languettes rouges ou en soufflant dans les tuyaux des deux côtés. Ne gonflez pas le gilet avant de sortir de l'avion. Si des masques à oxygène sont nécessaires, ils tomberont automatiquement du panneau au-dessus. Placez le masque sur votre nez et votre bouche, sécurisez-le avec le bandeau élastique et respirez normalement. De l'aide vous sera fournie une fois que tout le monde aura mis son masque. Nous vous remercions de votre coopération pour assurer votre sécurité et votre confort. Merci.",
        "it": "Signore e signori, mentre ci prepariamo per il decollo, vi chiediamo gentilmente di prestare la massima attenzione mentre rivediamo le caratteristiche di sicurezza di questo aereo. Le cinture di sicurezza devono essere allacciate in questo momento, e tutti gli oggetti a mano devono essere riposti nei compartimenti sopra il sedile o sotto il sedile davanti a voi. In caso di emergenza, seguite le uscite illuminate per localizzare l'uscita più vicina. Ricordate che l'uscita più vicina potrebbe essere dietro di voi. In caso improbabile di un atterraggio in acqua, questo aereo è dotato di giubbotti salvagente sotto il vostro sedile. Per utilizzarli, tirate fuori il giubbotto, mettetelo sopra la testa e fissate le cinghie. Gonfiate il giubbotto tirando le linguette rosse o soffiando nei tubi sui due lati. Non gonfiate il giubbotto fino a quando non uscite dall'aereo. Se sono necessari maschere di ossigeno, queste cadranno automaticamente dal pannello sopra di voi. Posizionate la maschera sul naso e sulla bocca, fissate con l'elastico e respirate normalmente. L'assistenza sarà fornita quando tutti avranno indossato la propria maschera. Vi ringraziamo per la vostra collaborazione mentre assicuriamo la vostra sicurezza e il vostro comfort. Grazie.",
        "tr": "Bayanlar ve baylar, kalkışa hazırlanırken, bu uçağın güvenlik özelliklerini gözden geçirirken tam dikkatinizi rica ederiz. Şu anda emniyet kemerleri takılmalı ve tüm el bagajları baş üstü dolaplarında veya önünüzdeki koltuk altına yerleştirilmelidir. Acil bir durumda, en yakın çıkışı bulmak için aydınlatılmış çıkış işaretlerini takip edin. Unutmayın, en yakın çıkışınız arkada olabilir. Suya iniş gibi nadir bir durumda, bu uçakta koltuk altınızda bulunan can yelekleri bulunmaktadır. Kullanmak için yeleği çıkarın, başınızdan geçirin ve kayışları sıkın. Yeleği, kırmızı sekmeleri çekerek veya her iki taraftaki tüpleri üfleyerek şişirin. Uçağı terk etmeden yeleğinizi şişirmeyin. Oksijen maskelerine ihtiyaç duyulursa, yukarıdaki panelden otomatik olarak düşecektir. Maskeyi burnunuza ve ağzınıza yerleştirin, elastik bandı takın ve normal bir şekilde nefes alın. Yardım, herkes maskesini taktıktan sonra sağlanacaktır. Güvenliğiniz ve konforunuz için işbirliğiniz için teşekkür ederiz.",
        "nl": "Dames en heren, terwijl we ons voorbereiden op vertrek, verzoeken wij u vriendelijk om volledige aandacht terwijl we de veiligheidskenmerken van dit vliegtuig doornemen. De veiligheidsgordels moeten nu vastgemaakt worden, en alle handbagage moet worden opgeborgen in de bovenste vakken of onder de stoel voor u. In geval van nood volgt u de verlichte uitgangsborden om uw dichtstbijzijnde uitgang te vinden. Vergeet niet dat uw dichtstbijzijnde uitgang achter u kan zijn. In het onwaarschijnlijke geval van een waterlanding is dit vliegtuig uitgerust met reddingsvesten onder uw stoel. Om de wester te gebruiken, haalt u het vest eruit, trekt het over uw hoofd en bevestigt het met de riemen. Blaas het vest op door aan de rode tabs te trekken of door in de buisjes aan beide zijden te blazen. Blaas het vest niet op totdat u het vliegtuig verlaat. Als zuurstofmaskers nodig zijn, vallen ze automatisch uit het paneel boven u. Plaats het masker over uw neus en mond, zet het vast met het elastische bandje en adem normaal. Hulp wordt geboden zodra iedereen zijn masker heeft opgezet. Wij danken u voor uw medewerking terwijl wij uw veiligheid en comfort waarborgen. Dank u.",
        "ko": "승객 여러분, 출발 준비를 하면서 이 항공기의 안전 기능을 안내 드리겠습니다. 이때 좌석벨트를 매주시고 모든 기내 반입 수하물은 머리 위 선반이나 앞 좌석 아래에 보관하셔야 합니다. 비상시, 비상구 표지판을 따라 가장 가까운 출구를 찾으십시오. 가장 가까운 출구가 뒤에 있을 수 있습니다. 물에 착수하는 불가능한 상황에서는 이 항공기는 좌석 아래에 구명조끼가 장착되어 있습니다. 사용하려면 조끼를 꺼내어 머리에 착용하고 스트랩을 조여주세요. 빨간 탭을 당기거나 양쪽 튜브에 불어 넣어 조끼를 부풀리세요. 항공기를 떠나기 전까지는 조끼를 부풀리지 마십시오. 산소마스크가 필요하면 자동으로 위쪽 패널에서 떨어집니다. 마스크를 코와 입에 올리고, 고무밴드로 고정하고 정상적으로 호흡하십시오. 모두가 마스크를 착용한 후에 도움을 드리겠습니다. 여러분의 안전과 편안함을 위해 협조해주셔서 감사합니다.",
        "pt_pt": "Senhoras e senhores, enquanto nos preparamos para a descolagem, pedimos gentilmente a sua total atenção enquanto passamos pelas características de segurança desta aeronave. Os cintos de segurança devem ser afivelados neste momento, e todos os itens de mão devem ser armazenados nos compartimentos acima ou sob o assento à sua frente. Em caso de emergência, siga os sinais de saída iluminados para localizar a saída mais próxima. Lembre-se de que a saída mais próxima pode estar atrás de você. No improvável caso de um pouso na água, esta aeronave está equipada com coletes salva-vidas localizados sob o seu assento. Para usá-los, retire o colete, coloque-o sobre a cabeça e aperte as correias. Infle o colete puxando as abas vermelhas ou soprando nos tubos dos dois lados. Não infle o colete até sair da aeronave. Se as máscaras de oxigênio forem necessárias, elas cairão automaticamente do painel acima. Coloque a máscara sobre o nariz e a boca, prenda-a com a faixa elástica e respire normalmente. A assistência será fornecida assim que todos tiverem suas máscaras. Agradecemos a sua colaboração enquanto garantimos a sua segurança e conforto. Obrigado.",
        "no": "Mine damer og herrer, mens vi forbereder oss på avgang, ber vi om full oppmerksomhet mens vi går gjennom sikkerhetsfunksjonene på dette flyet. Sikkerhetsbeltet skal være festet på dette tidspunktet, og alle håndbagasjeartikler må oppbevares i de øverste hyllene eller under setet foran deg. I tilfelle en nødsituasjon, følg de opplyste nødutgangsskiltene for å finne din nærmeste utgang. Husk at nærmeste utgang kan være bak deg. I det usannsynlige tilfellet av en vannlanding er dette flyet utstyrt med redningsvester som er plassert under setet ditt. For å bruke vesten, ta den ut, dra den over hodet og fest stroppene. Blås opp vesten ved å trekke i de røde klaffene eller ved å blåse inn i rørene på begge sider. Ikke blåse opp vesten før du forlater flyet. Hvis oksygenmasker er nødvendig, vil de automatisk falle fra panelet over deg. Plasser masken over nesen og munnen, fest den med elastikkbåndet og pust normalt. Hjelp vil bli gitt når alle har på seg masken. Vi takker for samarbeidet når vi sørger for din sikkerhet og komfort. Takk.",
        "th": "ท่านผู้โดยสารทุกท่าน ในขณะที่เรากำลังเตรียมตัวสำหรับการออกเดินทาง ขอความกรุณาให้ท่านให้ความสนใจเต็มที่ ขณะนี้เราจะอธิบายฟีเจอร์ด้านความปลอดภัยของเครื่องบินนี้ โปรดคาดเข็มขัดนิรภัยในขณะนี้ และโปรดเก็บสัมภาระของท่านในช่องเหนือศีรษะหรือใต้ที่นั่งด้านหน้าท่าน หากเกิดเหตุฉุกเฉิน โปรดติดตามป้ายทางออกที่สว่างเพื่อหาทางออกที่ใกล้ที่สุด โปรดจำไว้ว่าทางออกที่ใกล้ที่สุดอาจอยู่ด้านหลังท่าน ในกรณีที่เครื่องบินลงจอดในน้ำ เครื่องบินนี้มีเสื้อชูชีพอยู่ใต้ที่นั่งของท่าน ใช้เสื้อชูชีพได้โดยดึงออกมา สวมใส่ที่ศีรษะ และรัดด้วยสายรัด จากนั้นเป่าลมเข้าไปในท่อทั้งสองข้างจนเสื้อชูชีพพองตัว อย่าเป่าลมในเสื้อชูชีพจนกว่าจะออกจากเครื่องบิน หากต้องใช้หน้ากากออกซิเจน หน้ากากจะหล่นออกมาจากแผงด้านบน สวมหน้ากากครอบจมูกและปาก รัดด้วยยางยืดแล้วหายใจตามปกติ จะมีเจ้าหน้าที่ช่วยเหลือหลังจากทุกคนสวมหน้ากากแล้ว ขอบคุณสำหรับความร่วมมือในการรักษาความปลอดภัยและความสะดวกสบายของท่าน",
        "zh": "女士们，先生们，在我们准备起飞时，请您全神贯注地听取飞机安全设施的介绍。此时请系好安全带，并确保所有随身物品已存放在头顶行李舱或前方座位下方。遇到紧急情况时，请按照照明的紧急出口标志前往最近的出口。请记住，最近的出口可能在您的后方。如果发生水上迫降，本机配有位于座位下方的救生衣。使用时，请将救生衣拉出，套过头部并系紧带子。通过拉红色标签或向两侧的管道吹气来充气。请勿在离开飞机前充气。如果需要氧气面罩，它们将自动从上方面板掉下。请将面罩覆盖在您的鼻子和嘴巴上，并用松紧带固定，正常呼吸。所有乘客戴好面罩后将提供帮助。感谢您的配合，以确保您的安全和舒适。谢谢。",
        "ja": "皆様、出発準備が整いましたので、この航空機の安全機能についてご説明しますので、どうぞご用心ください。この時点でシートベルトを締めてください。また、すべての機内持ち込み手荷物は頭上の棚または前の座席の下に収納してください。緊急事態が発生した場合は、点灯した出口標識に従って最寄りの出口を見つけてください。最寄りの出口は後ろにある場合があることにご注意ください。万が一、着水した場合に備えて、この航空機には座席の下にライフベストが装備されています。使用するには、ベストを引き出し、頭からかぶってストラップで固定します。赤いタブを引くか、両側のチューブに息を吹き込んでベストを膨らませます。航空機を出るまではベストを膨らませないでください。酸素マスクが必要な場合は、上部のパネルから自動的に落下します。マスクを鼻と口に当て、ゴムバンドで固定し、普通に呼吸してください。全員がマスクを着用したら、支援が提供されます。お客様の安全と快適さを確保するためにご協力をお願いいたします。ありがとうございます。",
  ...
  },
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "ja": "離陸時には照明を暗くさせていただきます。追加の照明が必要な場合は、座席の上にある読書灯をご利用ください。",
      ...
      },
      {
        ...
        "ja": "皆様、離陸にあたり客室の照明を暗くさせていただきます。追加の照明が必要な場合は、座席の上にあるボタンを使用して読書灯を点灯してください。",
    ...
    "texts": [
      {
        ...
        "ja": "皆様、巡航高度まで上昇中はお席にご着席ください。まもなく機内サービスが始まります。スカイ メニューは前方の座席ポケットにあります。",
      ...
      },
      {
        ...
        "ja": "現在、巡航高度まで上昇中です。まもなく機内サービスが始まります。スカイ メニューは前方の座席ポケットにあります。",
      ...
      },
      {
        ...
        "ja": "皆様、まもなく客室乗務員が軽食の提供を開始します。トレーテーブルを下ろして、お選びいただけるようにしてください。",
      ...
      },
      {
        ...
        "pl": "Szanowni Państwo, obecnie wznosimy się na naszą wysokość przelotową. Dla Państwa bezpieczeństwa prosimy pozostać na swoich miejscach z zapiętymi pasami. Po osiągnięciu wysokości przelotowej załoga rozpocznie serwis pokładowy. Jeśli możemy zrobić coś, aby uczynić Państwa lot bardziej komfortowym, prosimy dać nam znać.",
        "de": "Meine Damen und Herren, wir steigen nun auf unsere Reiseflughöhe. Zu Ihrer Sicherheit bleiben Sie bitte auf Ihren Sitzen und halten Sie Ihren Sicherheitsgurt geschlossen. Sobald wir die Reiseflughöhe erreicht haben, beginnt die Kabinencrew mit dem Bordservice. Wenn wir etwas tun können, um Ihren Flug angenehmer zu gestalten, lassen Sie es uns bitte wissen.",
        "pt_br": "Senhoras e senhores, estamos subindo para nossa altitude de cruzeiro. Por sua segurança, permaneçam sentados com o cinto de segurança afivelado. Assim que atingirmos a altitude de cruzeiro, nossa tripulação iniciará o serviço de bordo. Se pudermos fazer algo para tornar seu voo mais confortável, por favor, avise-nos.",
        "es": "Damas y caballeros, estamos ascendiendo a nuestra altitud de crucero. Por su seguridad, por favor permanezcan sentados con el cinturón de seguridad abrochado. Una vez que alcancemos la altitud de crucero, nuestra tripulación comenzará el servicio a bordo. Si hay algo que podamos hacer para que su vuelo sea más cómodo, no dude en hacérnoslo saber.",
        "fr": "Mesdames et messieurs, nous montons maintenant à notre altitude de croisière. Pour votre sécurité, veuillez rester assis avec votre ceinture attachée. Une fois la croisière atteinte, notre équipage commencera le service à bord. Si nous pouvons faire quoi que ce soit pour rendre votre vol plus confortable, veuillez nous le faire savoir.",
        "it": "Signore e signori, stiamo salendo alla nostra altitudine di crociera. Per la vostra sicurezza, vi preghiamo di rimanere seduti con la cintura di sicurezza allacciata. Una volta raggiunta l'altitudine di crociera, il nostro equipaggio inizierà il servizio a bordo. Se possiamo fare qualcosa per rendere il vostro volo più confortevole, non esitate a farcelo sapere.",
        "tr": "Sayın yolcularımız, şu anda seyir irtifamıza yükseliyoruz. Güvenliğiniz için lütfen kemerlerinizi bağlı tutarak yerinizde kalınız. Seyir irtifasına ulaştığımızda kabin ekibimiz uçak içi servise başlayacaktır. Uçuşunuzu daha konforlu hale getirmek için yapabileceğimiz bir şey varsa, lütfen bize bildirin.",
        "nl": "Dames en heren, we stijgen nu naar onze kruishoogte. Voor uw veiligheid verzoeken wij u om op uw plaats te blijven zitten en uw veiligheidsgordel vast te maken. Zodra we op kruishoogte zijn, zal onze cabinebemanning de boordservice beginnen. Laat het ons weten als er iets is dat we kunnen doen om uw vlucht comfortabeler te maken.",
        "ko": "승객 여러분, 현재 순항 고도로 상승하고 있습니다. 안전을 위해 좌석에 앉아 안전벨트를 착용해 주시기 바랍니다. 순항 고도에 도달하면 객실 승무원이 기내 서비스를 시작할 예정입니다. 보다 편안한 비행이 될 수 있도록 필요한 점이 있다면 알려주시기 바랍니다.",
        "pt_pt": "Senhoras e senhores, estamos a subir para a nossa altitude de cruzeiro. Para sua segurança, permaneçam sentados com o cinto de segurança apertado. Assim que atingirmos a altitude de cruzeiro, a nossa tripulação iniciará o serviço de bordo. Se houver algo que possamos fazer para tornar o seu voo mais confortável, por favor informe-nos.",
        "no": "Mine damer og herrer, vi stiger nå opp til vår marsjhøyde. For deres sikkerhet, vennligst bli sittende med setebeltet fastspent. Når vi har nådd marsjhøyden, vil kabinbesetningen starte serveringen om bord. Hvis det er noe vi kan gjøre for å gjøre flyturen mer behagelig, gi oss beskjed.",
        "th": "เรียนผู้โดยสารทุกท่าน ขณะนี้เรากำลังไต่ระดับไปยังระดับความสูงเดินทางของเรา เพื่อความปลอดภัยของท่าน กรุณานั่งอยู่ในที่นั่งและคาดเข็มขัดนิรภัยให้เรียบร้อย เมื่อถึงระดับความสูงเดินทางแล้ว ลูกเรือของเราจะเริ่มให้บริการบนเครื่อง หากมีสิ่งใดที่เราสามารถทำเพื่อให้การเดินทางของท่านสะดวกสบายยิ่งขึ้น โปรดแจ้งให้เราทราบ",
        "zh": "各位乘客，我们现在正在爬升至巡航高度。为了您的安全，请保持就座并系好安全带。当我们达到巡航高度后，机组人员将开始机上服务。如果您需要任何帮助，请随时告知我们的机组成员。感谢您选择与我们一起飞行。",
        "ja": "皆様、現在、巡航高度まで上昇中です。安全のため、シートベルトを締めてお座りください。機体が水平飛行したら、客室乗務員が機内サービスを開始します。お客様のフライトをより快適にするために何かできることがございましたら、お知らせください。",
      ...
      },
      {
        ...
        "pl": "Drodzy pasażerowie, wznosimy się na naszą wysokość przelotową. W tym czasie prosimy o pozostanie na miejscach i zapięcie pasów bezpieczeństwa. Wkrótce rozpoczniemy serwis pokładowy. Naszą ofertę napojów i posiłków znajdą Państwo w menu pokładowym, które znajduje się w kieszeni przed Państwa siedzeniem.",
        "de": "Liebe Fluggäste, wir steigen auf unsere Reiseflughöhe. Währenddessen bitten wir Sie, sitzen zu bleiben und Ihren Sicherheitsgurt geschlossen zu halten. In Kürze beginnen wir mit dem Bordservice. Unsere Auswahl an Erfrischungen und Mahlzeiten finden Sie im Sky-Menü, das sich in der Sitztasche vor Ihnen befindet.",
        "pt_br": "Prezados passageiros, estamos subindo para nossa altitude de cruzeiro. Durante este momento, pedimos que permaneçam sentados com o cinto de segurança devidamente afivelado. Em breve, iniciaremos o serviço de bordo. Vocês podem conferir nossa seleção de bebidas e refeições no menu de bordo, localizado no bolso à sua frente.",
        "es": "Estimados pasajeros, estamos ascendiendo a nuestra altitud de crucero. Durante este tiempo, les pedimos que permanezcan sentados con el cinturón de seguridad abrochado. En breve, comenzaremos nuestro servicio a bordo. Pueden consultar nuestra selección de refrescos y comidas en el menú de vuelo, ubicado en el bolsillo de su asiento.",
        "fr": "Chers passagers, nous montons à notre altitude de croisière. Pendant ce temps, nous vous demandons de rester assis avec votre ceinture attachée. Nous commencerons bientôt notre service à bord. Vous pouvez consulter notre sélection de rafraîchissements et de repas dans le menu de bord, situé dans la pochette de votre siège.",
        "it": "Gentili passeggeri, stiamo salendo alla nostra altitudine di crociera. Durante questo momento, vi chiediamo di rimanere seduti con la cintura di sicurezza allacciata. A breve inizieremo il servizio a bordo. Potete consultare la nostra selezione di bevande e pasti nel menu di bordo, situato nella tasca del sedile davanti a voi.",
        "tr": "Değerli yolcularımız, şu anda seyir irtifamıza yükseliyoruz. Bu sırada lütfen koltuğunuzda oturun ve emniyet kemerinizin bağlı olduğundan emin olun. Kısa süre içinde uçak içi servise başlayacağız. İkramlarımızı ve yemeklerimizi koltuğunuzun önündeki cepten ulaşabileceğiniz menümüzde inceleyebilirsiniz.",
        "nl": "Beste passagiers, we stijgen naar onze kruishoogte. We verzoeken u tijdens deze tijd op uw stoel te blijven zitten en uw veiligheidsgordel stevig vast te maken. Binnenkort beginnen we met onze boordservice. U kunt ons assortiment aan drankjes en maaltijden bekijken in het Sky-menu, dat handig in de stoelzak voor u is geplaatst.",
        "ko": "승객 여러분, 저희는 현재 순항 고도로 상승 중입니다. 이 시간 동안 좌석에 앉아 안전벨트를 단단히 매주시길 부탁드립니다. 곧 기내 서비스를 시작할 예정입니다. 좌석 앞 주머니에 비치된 스카이 메뉴를 통해 음료와 식사 선택을 확인하실 수 있습니다.",
        "pt_pt": "Caros passageiros, estamos a subir para a nossa altitude de cruzeiro. Durante este período, pedimos que permaneçam sentados com o cinto de segurança devidamente apertado. Dentro de momentos, iniciaremos o serviço de bordo. Pode consultar a nossa seleção de refrescos e refeições no menu de bordo, localizado no bolso do assento à sua frente.",
        "no": "Kjære passasjerer, vi stiger nå opp til vår marsjhøyde. Vi ber dere om å bli sittende og holde setebeltet forsvarlig festet i denne perioden. Snart vil vi starte serveringen om bord. Du finner vårt utvalg av forfriskninger og måltider i menyen, som ligger i setelommen foran deg.",
        "th": "เรียนผู้โดยสารทุกท่าน ขณะนี้เรากำลังไต่ระดับไปยังระดับความสูงเดินทางของเรา ระหว่างนี้กรุณานั่งอยู่ในที่นั่งและคาดเข็มขัดนิรภัยให้แน่น ในไม่ช้าเราจะเริ่มให้บริการบนเครื่อง ท่านสามารถดูตัวเลือกเครื่องดื่มและอาหารได้จากเมนูบนเครื่องซึ่งอยู่ในกระเป๋าที่นั่งของท่าน",
        "zh": "各位乘客，我们现在正在爬升至巡航高度。在此期间，请保持就座并系好安全带。不久后，我们将开始机上服务。您可以在座椅前方的口袋中找到机上菜单，浏览我们的饮品和餐食选择。",
        "ja": "お客様各位、現在、巡航高度まで上昇中です。その間、シートベルトをしっかりと締めて着席したままでお待ちください。まもなく機内サービスを開始します。機内メニューには、シートポケットに便利な軽食やお食事をご用意しておりますので、ぜひご覧ください。",
      ...
      },
      {
        ...
        "pl": "Szanowni Państwo, podczas wznoszenia się na wysokość przelotową prosimy o pozostanie na miejscach i zapięcie pasów bezpieczeństwa. Personel pokładowy rozpocznie serwis napojów, gdy będzie to bezpieczne. Państwa komfort i bezpieczeństwo są dla nas priorytetem. Dziękujemy za współpracę.",
        "de": "Sehr geehrte Damen und Herren, während wir auf unsere Reiseflughöhe steigen, bitten wir Sie, sitzen zu bleiben und Ihren Sicherheitsgurt jederzeit geschlossen zu halten. Die Kabinencrew wird mit dem Servieren von Erfrischungen beginnen, sobald es sicher ist. Ihr Komfort und Ihre Sicherheit haben für uns oberste Priorität. Vielen Dank für Ihre Kooperation.",
        "pt_br": "Senhoras e senhores, enquanto subimos para nossa altitude de cruzeiro, pedimos que permaneçam sentados e mantenham os cintos de segurança afivelados o tempo todo. A equipe de bordo começará a servir os refrescos assim que for seguro. Seu conforto e segurança são nossa prioridade. Obrigado pela cooperação.",
        "es": "Damas y caballeros, mientras ascendemos a nuestra altitud de crucero, les pedimos que permanezcan sentados y mantengan el cinturón de seguridad abrochado en todo momento. La tripulación comenzará a servir refrescos cuando sea seguro hacerlo. Su comodidad y seguridad son nuestra prioridad. Gracias por su cooperación.",
        "fr": "Mesdames et Messieurs, pendant que nous montons à notre altitude de croisière, veuillez rester assis et garder votre ceinture attachée en tout temps. L'équipage commencera à servir les rafraîchissements dès que cela sera sûr. Votre confort et votre sécurité sont notre priorité. Merci de votre coopération.",
        "it": "Signore e signori, mentre saliamo alla nostra altitudine di crociera, vi preghiamo di rimanere seduti e di tenere sempre allacciata la cintura di sicurezza. L'equipaggio inizierà a servire le bevande appena sarà sicuro farlo. Il vostro comfort e la vostra sicurezza sono la nostra priorità. Grazie per la collaborazione.",
        "tr": "Sayın yolcularımız, seyir irtifamıza tırmanırken lütfen koltuklarınızda oturmaya devam edin ve emniyet kemerinizi her zaman bağlı tutun. Kabin ekibimiz ikram servisine güvenli olduğu anda başlayacaktır. Konforunuz ve güvenliğiniz bizim önceliğimizdir. İş birliğiniz için teşekkür ederiz.",
        "nl": "Dames en heren, terwijl we naar onze kruishoogte klimmen, verzoeken wij u om te blijven zitten en uw veiligheidsgordel te allen tijde vast te houden. De bemanning zal beginnen met het serveren van drankjes zodra dit veilig is. Uw comfort en veiligheid zijn onze prioriteit. Dank u voor uw medewerking.",
        "ko": "승객 여러분, 순항 고도로 상승하는 동안 좌석에 앉아 안전벨트를 항상 착용해 주시기 바랍니다. 안전이 확보되면 객실 승무원이 음료 서비스를 시작할 것입니다. 여러분의 편안함과 안전은 우리의 최우선 순위입니다. 협조해 주셔서 감사합니다.",
        "pt_pt": "Senhoras e senhores, enquanto subimos para a nossa altitude de cruzeiro, pedimos que permaneçam sentados e mantenham os cintos de segurança apertados a todo o momento. A tripulação de cabine começará a servir as bebidas assim que for seguro fazê-lo. O seu conforto e segurança são a nossa prioridade. Obrigado pela vossa colaboração.",
        "no": "Kjære passasjerer, mens vi stiger til vår marsjhøyde, ber vi dere om å forbli sittende og holde setebeltet fastspent til enhver tid. Kabinpersonalet vil begynne servering av forfriskninger så snart det er trygt. Deres komfort og sikkerhet er vår prioritet. Takk for deres samarbeid.",
        "th": "เรียนผู้โดยสารทุกท่าน ขณะนี้เรากำลังไต่ระดับไปยังระดับความสูงเดินทาง กรุณานั่งประจำที่และคาดเข็มขัดนิรภัยให้แน่นตลอดเวลา พนักงานต้อนรับบนเครื่องจะเริ่มให้บริการเครื่องดื่มเมื่อปลอดภัยแล้ว ความสะดวกสบายและความปลอดภัยของท่านคือสิ่งสำคัญของเรา ขอขอบคุณสำหรับความร่วมมือ",
        "zh": "各位乘客，在我们爬升至巡航高度期间，请始终保持就座并系好安全带。机组人员将在安全的情况下开始提供饮品服务。您的舒适和安全是我们的首要任务。感谢您的合作。",
        "ja": "皆様、巡航高度まで上昇中は、座席に座ったまま、常にシートベルトをお締めください。客室乗務員は、安全が確保でき次第、軽食の提供を開始します。お客様の快適さと安全は、私たちの最優先事項です。ご協力のほどよろしくお願いいたします。",
      ...
      },
      {
        ...
        "pl": "Wznosimy się na wysokość przelotową! Prosimy o pozostanie na miejscach i zapięcie pasów bezpieczeństwa. Już za chwilę rozpoczniemy serwis przekąsek i napojów. Zachęcamy do zapoznania się z menu, które znajdziecie w kieszeni przed wami.",
        "de": "Wir steigen auf unsere Reiseflughöhe! Bitte bleiben Sie angeschnallt sitzen und genießen Sie die Aussicht während des Aufstiegs. In Kürze beginnen wir mit dem Servieren von Snacks und Getränken. Werfen Sie einen Blick in die Speisekarte in der Tasche vor Ihnen.",
        "pt_br": "Estamos subindo para a altitude de cruzeiro! Por favor, mantenha o cinto de segurança afivelado e aproveite a vista enquanto subimos. Em breve, começaremos a servir lanches e bebidas. Aproveite para conferir o menu no bolso do assento à sua frente.",
        "es": "¡Estamos subiendo a nuestra altitud de crucero! Por favor, mantengan sus cinturones de seguridad abrochados y disfruten de la vista mientras ascendemos. En breve comenzaremos a servir snacks y bebidas. Tómense un momento para revisar el menú en el bolsillo del asiento frente a ustedes.",
        "fr": "Nous montons à notre altitude de croisière ! Veuillez garder votre ceinture attachée et profiter de la vue pendant l'ascension. Dans quelques instants, nous commencerons à servir des collations et des boissons. Prenez un moment pour consulter le menu dans la pochette devant vous.",
        "it": "Stiamo salendo alla nostra altitudine di crociera! Per favore, tenete le cinture allacciate e godetevi la vista durante la salita. Tra poco inizieremo a servire snack e bevande. Date un'occhiata al menu nella tasca del sedile di fronte a voi.",
        "tr": "Seyir irtifamıza doğru yükseliyoruz! Lütfen kemerinizi bağlı tutun ve tırmanış sırasında manzaranın keyfini çıkarın. Birazdan atıştırmalıklar ve içecek servisine başlayacağız. Önünüzdeki koltuğun cebindeki menüyü incelemeyi unutmayın.",
        "nl": "We zijn onderweg naar onze kruishoogte! Houd uw veiligheidsgordel vast en geniet van het uitzicht tijdens het stijgen. Over een klein moment beginnen we met het serveren van snacks en drankjes. Neem een kijkje in het menu in de stoelzak voor u.",
        "ko": "순항 고도로 올라가고 있습니다! 안전벨트를 착용한 채로 멋진 경치를 즐겨 보세요. 잠시 후 스낵과 음료 서비스가 시작됩니다. 앞 좌석 주머니에 있는 메뉴를 확인해 보세요.",
        "pt_pt": "Estamos a subir para a altitude de cruzeiro! Por favor, mantenham os cintos de segurança apertados e aproveitem a vista enquanto subimos. Dentro de momentos, começaremos a servir snacks e bebidas. Aproveitem para consultar o menu no bolso do assento à vossa frente.",
        "no": "Vi er på vei opp til marsjhøyde! Vennligst hold setebeltet festet og nyt utsikten mens vi stiger. Om kort tid begynner vi servering av snacks og drikke. Ta en titt på menyen i lommen på setet foran deg.",
        "th": "เรากำลังไต่ระดับไปยังระดับความสูงเดินทาง! โปรดคาดเข็มขัดนิรภัยและเพลิดเพลินกับวิวระหว่างการไต่ระดับ อีกไม่นานเราจะเริ่มให้บริการของว่างและเครื่องดื่ม อย่าลืมดูเมนูในกระเป๋าที่นั่งด้านหน้าของคุณ",
        "zh": "我们正在爬升到巡航高度！请保持系好安全带，欣赏爬升中的美景。不久之后，我们将开始提供小吃和饮料服务。请抽空查看您座椅前方口袋中的菜单。",
        "ja": "巡航高度まで上昇中です。上昇中はシートベルトを締めて景色をお楽しみください。まもなく軽食とドリンクの提供が始まります。座席前のポケットにあるメニューをぜひご覧ください。",
  ...
  },
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "ja": "皆様、この旅程の間、機内ショッピング サービスをご提供いたします。心のこもった贈り物、旅行の必需品、あるいは単に自分へのご褒美をお探しの場合でも、私たちが対応いたします。座席ポケットのカタログをご覧になり、ご質問がございましたら乗務員までお尋ねください。お支払いは現金またはカードで承ります。",
      ...
      },
      {
        ...
        "ja": "乗客の皆様へ！このフライト限定の特別オファーをお見逃しなく。免税品を 2 つご購入いただくと、3 つ目が 20% オフになります。当社のカタログには、高級フレグランス、ガジェット、旅行限定商品など、幅広い商品が掲載されています。シートポケットにあるカタログを見つけて、客室乗務員に詳細をお尋ねください。",
  ...
  // Random information about the flight
  {
    ...
    "texts": [
      {
        "en": "Ladies and gentleman, this is your captain speaking. Let me share some information with you. We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour. Temperature outside is {currentTemperature} degrees. The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees. The rest of the flight should be smooth, with a small chance of light turbulences. Please remember to keep your seatbelt fastened while seated and whenever the seatbelt sign is illuminated. Thank you, and enjoy the flight.",
        "pl": "Szanowni państwo, tu kapitan. Podzielę się z Wami kilkoma informacjami. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Reszta lotu powinna być spokojna, z małymi szansami na lekkie turbulencje. Proszę pamiętać o zapięciu pasów bezpieczeństwa podczas siedzenia i zawsze, gdy sygnał zapięcia pasów jest włączony. Dziękuję i miłego lotu.",
        ...
        "pt_br": "Senhoras e senhores, aqui é o comandante falando. Deixe-me compartilhar algumas informações com você. Eu gostaria de compartilhar algumas informações com vocês. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O restante do voo deve ser tranquilo, com pequenas chances de turbulências leves. Lembre-se de manter o cinto de segurança afivelado enquanto estiver sentado e sempre que o aviso de atar os cintos estiver aceso. Obrigado e aproveite o vôo.",
        ...
        "fr": "Mesdames et messieurs, ici le commandant de bord. J'aimerais vous partager quelques informations sur notre vol. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Le reste du vol devrait être calme, avec une faible possibilité de légères turbulences. Merci de garder votre ceinture de sécurité attachée pendant que vous êtes assis et chaque fois que le signal de ceinture est allumé. Merci et bon vol.",
        "it": "Signore e signori, parla il vostro comandante. Vorrei darvi alcune informazioni. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo, con una piccola possibilità di leggere turbolenze. Vi preghiamo di tenere sempre la cintura di sicurezza allacciata mentre siete seduti e ogni volta che il segnale della cintura è acceso. Grazie e buon volo.",
        "tr": "Bayanlar ve baylar, kaptanınız konuşuyor. Sizinle bazı bilgileri paylaşayım. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Uçuşun geri kalanı, hafif türbülansların az da olsa yaşanması ihtimaliyle birlikte sorunsuz geçmelidir. Lütfen oturduğunuzda ve emniyet kemeri işareti yandığında emniyet kemerinizi bağlı tutmayı unutmayın. Teşekkür ederim ve uçuşun tadını çıkarın.",
        "nl": "Dames en heren, hier spreekt uw gezagvoerder. Ik wil graag wat informatie met u delen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] De rest van de vlucht zou vlot moeten verlopen, met een kleine kans op lichte turbulentie. Vergeet niet uw veiligheidsgordel te dragen wanneer u zit en wanneer het stoelriemen vast teken is geactiveerd. Bedankt en geniet van uw vlucht.",
        "ko": "승객 여러분, 기장입니다. 몇 가지 정보를 여러분과 공유하겠습니다. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] {destinationCityName}의 날씨는 {destinationCityWheatherHumanDescription}이며 온도는 {destinationCityTemperature}도입니다. 앞으로 난기류가 발생할 가능성이 적으며 순조로운 비행이 될 것으로 보입니다. 자리에 앉아 좌석벨트 싸인에 불이 켜질 때마다 좌석벨트 착용하는 것을 기억하시기 바랍니다. 감사합니다, 즐거운 비행 되세요.",
        "pt_pt": "Senhoras e senhores, fala o vosso comandante. Deixem-me partilhar algumas informações convosco. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O resto do voo deverá ser tranquilo, com uma pequena possibilidade de ligeiras turbulências. Por favor, lembrem-se de manter o cinto de segurança apertado enquanto estiverem sentados e sempre que o sinal de apertar os cintos estiver iluminado. Obrigado e desfrutem do voo.",
        "no": "Mine damer og herrer, dette er kapteinen som snakker. La meg dele litt informasjon med dere. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Resten av flyturen bør bli jevn, med liten sjanse for lett turbulens. Vennligst husk å holde sikkerhetsbeltet festet mens dere sitter, og alltid når skiltet med fest-sikkerhetsbeltet er tent. Takk, og nyt flyturen.",
        ...
        "zh": "女士们，先生们，我是您的机长。让我与您分享一些信息。[We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] 接下来的飞行应该会非常平稳，仅有轻微颠簸的可能。请记得在座位上系好安全带，并在安全带标志亮起时保持系好状态。谢谢，祝您飞行愉快。",
      ...
      },
      {
        ...
        "pl": "Proszę Państwa, tu kapitan. Chciałem podzielić się z wami kilkoma informacjami. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Reszta lotu powinna być spokojna. W przypadku pytań, proszę zwrócić się do jednego z członków naszej załogi. Dziękuję i miłego lotu.",
        "de": "Hallo, hier ist Ihr Kapitän vom Flugdeck. Ich möchte ein paar Informationen mit Ihnen teilen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Der Rest des Fluges sollte ruhig verlaufen. Bei Fragen wenden Sie sich bitte an eines unserer Kabinenpersonalmitglieder. Danke und genießen Sie den Flug.",
        "pt_br": "Olá, aqui é o capitão do convés de voo. Eu gostaria de compartilhar algumas informações com vocês. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O restante do voo deve ser tranquilo. Em caso de dúvidas, não hesite em perguntar a um dos nossos comissários. Obrigado e aproveite o vôo.",
        "es": "Hola, soy su capitán desde la cabina de vuelo. Quería compartir algo de información contigo. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] El resto del vuelo debería transcurrir sin incidentes. Si tiene alguna pregunta, consulte a uno de los miembros de nuestra tripulación. Gracias y que tengas un buen vuelo.",
        "fr": "Bonjour, c'est votre capitaine depuis le poste de pilotage. Je voulais juste partager quelques informations avec vous. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Le reste du vol devrait être calme. Si vous avez des questions, n'hésitez pas à demander à l'un de nos membres d'équipage. Merci et bon vol.",
        "it": "Salve, sono il capitano della cabina di pilotaggio. Volevo condividere alcune informazioni sul nostro volo. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo. Se avete domande, non esitate a chiedere a uno dei membri dell’equipaggio. Grazie e buon volo.",
        "tr": "Merhaba, uçuş güvertesinden kaptanınız konuşuyor. Sadece sizinle bazı bilgileri paylaşmak istedim. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Uçuşun geri kalanı sorunsuz olmalı. Herhangi bir sorunuz olması durumunda lütfen kabin ekibimizden birine sormaktan çekinmeyin. Teşekkür ederim ve uçuşun tadını çıkarın.",
        "nl": "Hallo, dit is uw gezagvoerder vanuit de cockpit. Ik wil graag wat informatie met u delen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] De rest van de vlucht zou vlot moeten verlopen. Als u vragen heeft, stel ze dan gerust aan het cabinepersoneel. Bedankt en geniet van uw vlucht.",
        "ko": "안녕하세요. 비행 갑판의 선장입니다. 여러분과 정보를 나누고 싶어서요. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] {destinationCityName}의 날씨는 {destinationCityWeatherHumanDescription}이며 온도는 {destinationCityTemperature}도입니다. 남은 비행은 순조로울 것으로 보입니다. 궁금한 점이 있으시면 주저하지 말고 객실 승무원에게 물어보세요. 감사합니다. 즐거운 비행 되세요.",
        "pt_pt": "Olá, este é o seu capitão da cabine de pilotagem. Queria apenas partilhar algumas informações convosco. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O resto do voo deverá ser tranquilo. Em caso de dúvidas, por favor, não hesitem em perguntar a um dos nossos membros da tripulação de cabine. Obrigado e desfrutem do voo.",
        "no": "Hei, dette er kapteinen din fra flydekket. Jeg ville bare dele litt informasjon med dere. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Resten av flyturen bør bli jevn. Hvis dere har spørsmål, ikke nøl med å spørre en av våre kabinansatte. Takk, og nyt flyturen.",
        ...
        "zh": "您好，我是飞行甲板的机长。我想与您分享一些信息。[We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] 接下来的飞行应该会非常平稳。如果有任何问题，请随时向我们的机组人员提出。谢谢，祝您飞行愉快。",
    ...
    "texts": [
      {
        ...
        "de": "Meine Damen und Herren, ich möchte einige Informationen mit Ihnen teilen. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Der Rest des Fluges sollte ruhig verlaufen. Bei Fragen wenden Sie sich bitte an ein Crewmitglied. Vielen Dank und genießen Sie den Flug.",
        "pt_br": "Senhoras e senhores, gostaria de compartilhar algumas informações com vocês. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] O restante do voo deve ser tranquilo. Em caso de dúvidas, por favor, não hesite em perguntar a um dos nossos membros da tripulação. Obrigado e aproveite o voo.",
        "es": "Damas y caballeros, me gustaría compartir algunas información con ustedes. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] El resto del vuelo debería ser tranquilo. Si tiene alguna pregunta, no dude en preguntar a uno de nuestros miembros de la tripulación. Gracias y disfrute del vuelo.",
        "fr": "Mesdames et messieurs, j'aimerais partager quelques informations avec vous. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Le reste du vol devrait être calme. En cas de questions, n'hésitez pas à demander à un membre de notre équipage. Merci et profitez du vol.",
        "it": "Signore e signori, vorrei condividere alcune informazioni con voi. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo. In caso di domande, non esitate a chiedere a uno dei nostri membri dell'equipaggio. Grazie e buon volo.",
        "tr": "Bayanlar ve baylar, sizinle bazı bilgileri paylaşmak istiyorum. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Uçuşun geri kalan kısmı sorunsuz geçmelidir. Herhangi bir sorunuz olursa, lütfen bir kabin ekibi üyesine danışın. Teşekkür ederiz ve uçuşun tadını çıkarın.",
        "nl": "Dames en heren, ik wil graag wat informatie met u delen. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] De rest van de vlucht zou rustig moeten zijn. Als u vragen heeft, aarzel dan niet om een van onze bemanningsleden te vragen. Dank u en geniet van de vlucht.",
        "ko": "여러분, 몇 가지 정보를 공유하고자 합니다. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] 비행의 나머지 부분은 순조롭게 진행될 것입니다. 질문이 있으시면 기내 승무원에게 주저하지 마시고 문의해 주세요. 감사합니다. 즐거운 비행 되세요.",
        "pt_pt": "Senhoras e senhores, gostaria de partilhar algumas informações consigo. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] O resto do voo deve ser tranquilo. Em caso de dúvida, não hesite em perguntar a um dos membros da nossa tripulação. Obrigado e aproveite o voo.",
        "no": "Mine damer og herrer, jeg vil gjerne dele litt informasjon med dere. [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Resten av flyturen bør være jevn. Hvis du har noen spørsmål, vennligst ikke nøl med å spørre et av våre kabinbesetningsmedlemmer. Takk, og nyt flyturen.",
        "th": "ท่านผู้โดยสารทุกท่าน, ฉันขอแบ่งปันข้อมูลบางอย่างกับท่าน [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] ที่เหลือของเที่ยวบินจะเป็นไปอย่างราบรื่น หากท่านมีคำถามใด ๆ โปรดอย่าลังเลที่จะถามสมาชิกของลูกเรือ ขอบคุณค่ะและขอให้ท่านเพลิดเพลินกับการเดินทาง",
        "zh": "各位乘客，我想与您分享一些信息。 [We're currently flying near {currentPOIName}.] [You can see it by looking out of the window on the {currentPOIDirection} side of the aircraft.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] 剩下的航程应该很平稳。如果您有任何问题，请随时向我们的机组成员询问。谢谢，祝您旅途愉快。",
      ...
      },
      {
        ...
        "pl": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Mam nadzieję, że spędzają Państwo miło czas podczas dzisiejszego lotu. W razie pytań proszę zwrócić się do członków załogi. Dziękuję.",
        "de": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Ich hoffe, Sie genießen den Flug. Bei Fragen wenden Sie sich bitte an unser Kabinenpersonal. Vielen Dank.",
        "pt_br": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Espero que estejam aproveitando o voo. Se tiverem alguma dúvida, fiquem à vontade para perguntar aos nossos membros da tripulação. Obrigado.",
        "es": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Espero que estén disfrutando del vuelo. Si tienen alguna pregunta, no duden en preguntar a nuestra tripulación. Gracias.",
        "fr": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] J'espère que vous profitez bien du vol. Si vous avez des questions, n'hésitez pas à demander à notre équipe de cabine. Merci.",
        "it": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Spero che stiate godendo del volo. Se avete domande, non esitate a chiedere ai membri dell'equipaggio. Grazie.",
        "tr": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Umarım uçuşun tadını çıkarıyorsunuzdur. Herhangi bir sorunuz varsa, kabin ekibimize sormaktan çekinmeyin. Teşekkür ederiz.",
        "nl": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Ik hoop dat u geniet van de vlucht. Als u vragen heeft, aarzel dan niet om een van onze bemanningsleden te vragen. Dank u.",
        "ko": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] 비행을 즐기고 계시기를 바랍니다. 질문이 있으시면 기내 승무원에게 주저하지 마시고 문의해 주세요. 감사합니다.",
        "pt_pt": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Espero que esteja a desfrutar do voo. Se tiver alguma dúvida, não hesite em perguntar a um dos nossos membros da tripulação. Obrigado.",
        "no": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] Jeg håper du nyter flyturen. Hvis du har spørsmål, vennligst spør et av våre kabinbesetningsmedlemmer. Takk.",
        "th": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] หวังว่าท่านจะเพลิดเพลินกับการเดินทาง หากท่านมีคำถามใด ๆ โปรดอย่าลังเลที่จะถามสมาชิกของลูกเรือ ขอบคุณค่ะ",
        "zh": "[Dear passengers, we're currently flying near {currentPOIName}, it's on our {currentPOIDirection} side.] [The temperature outside is {currentTemperature} degrees.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] 希望您正在享受飞行。如果您有任何问题，请随时向我们的机组人员询问。谢谢。",
      ...
      },
      {
        ...
        "pl": "Pozdrowienia z kokpitu! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Mamy nadzieję, że cieszą się Państwo lotem i krajobrazem. [Thank you for flying with {airlineName}.]",
        "de": "Hallo aus dem Cockpit! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Wir hoffen, dass Sie den Flug und die Aussicht genießen. [Thank you for flying with {airlineName}.]",
        "pt_br": "Saudações da cabine de comando! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Esperamos que esteja aproveitando o voo e a paisagem. [Thank you for flying with {airlineName}.]",
        "es": "Saludos desde la cabina de vuelo! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Esperamos que esté disfrutando del vuelo y el paisaje. [Thank you for flying with {airlineName}.]",
        "fr": "Salutations depuis le cockpit ! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Nous espérons que vous profitez du vol et du paysage. [Thank you for flying with {airlineName}.]",
        "it": "Saluti dalla cabina di pilotaggio! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Speriamo che stiate apprezzando il volo e il paesaggio. [Thank you for flying with {airlineName}.]",
        "tr": "Kokpitten selamlar! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Umarız uçuşun ve manzaranın keyfini çıkarıyorsunuzdur. [Thank you for flying with {airlineName}.]",
        "nl": "Groeten vanuit de cockpit! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] We hopen dat u geniet van de vlucht en het landschap. [Thank you for flying with {airlineName}.]",
        "ko": "조종실에서 인사드립니다! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] 비행과 경치를 즐기고 계시기를 바랍니다. [Thank you for flying with {airlineName}.]",
        "pt_pt": "Saudações da cabine de pilotagem! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Esperamos que esteja a aproveitar o voo e a paisagem. [Thank you for flying with {airlineName}.]",
        "no": "Hilsener fra cockpiten! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] Vi håper du nyter flyreisen og utsikten. [Thank you for flying with {airlineName}.]",
        "th": "สวัสดีจากห้องนักบิน! [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] เราหวังว่าคุณจะสนุกกับเที่ยวบินและทิวทัศน์ [Thank you for flying with {airlineName}.]",
        "zh": "来自驾驶舱的问候！ [If you’re looking out on the {currentPOIDirection} side, you’ll spot {currentPOIName}, a truly beautiful sight from this altitude of {currentAltitudeFt} feet.] [We’re cruising at a steady {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour, with the outside temperature at {currentTemperature} degrees.] 我们希望您享受这次飞行和美丽的景色。 [Thank you for flying with {airlineName}].",
      ...
      },
      {
        ...
        "pl": "Panie i panowie, tu kapitan. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The temperature outside is {currentTemperature} degrees.] Mam nadzieję, że do tej pory podobał się Państwu lot. W razie pytań lub potrzeby pomocy, nasi członkowie załogi są do Państwa dyspozycji.",
        "de": "Meine Damen und Herren, hier spricht Ihr Kapitän. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'Kilometern' : 'Meilen' %} pro Stunde.] [The temperature outside is {currentTemperature} degrees.] Ich hoffe, dass Ihnen der Flug bisher gefällt. Falls Sie Fragen haben oder Hilfe benötigen, steht Ihnen unser Kabinenpersonal zur Verfügung.",
        "pt_br": "Senhoras e senhores, aqui é o capitão falando. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'quilômetros' : 'milhas' %} por hora.] [The temperature outside is {currentTemperature} degrees.] Espero que estejam desfrutando a viagem até agora. Se tiverem alguma dúvida ou precisarem de assistência, nossa tripulação está à disposição para ajudar.",
        "es": "Señoras y señores, habla su capitán. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilómetros' : 'millas' %} por hora.] [The temperature outside is {currentTemperature} degrees.] Espero que estén disfrutando del viaje hasta ahora. Si tienen alguna pregunta o necesitan ayuda, nuestra tripulación está a su disposición.",
        "fr": "Mesdames et messieurs, ici votre capitaine. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilomètres' : 'miles' %} par heure.] [The temperature outside is {currentTemperature} degrees.] J'espère que vous profitez bien du voyage jusqu'à présent. Si vous avez des questions ou avez besoin d'aide, notre équipage est là pour vous aider.",
        "it": "Signore e signori, qui parla il vostro capitano. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'chilometri' : 'miglia' %} all'ora.] [The temperature outside is {currentTemperature} degrees.] Spero che stiate apprezzando il viaggio finora. Se avete domande o necessitate di assistenza, il nostro equipaggio è a vostra disposizione.",
        "tr": "Bayanlar ve baylar, kaptanınız konuşuyor. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilometre' : 'mil' %} saatte.] [The temperature outside is {currentTemperature} degrees.] Umarım yolculuğunuzdan keyif alıyorsunuzdur. Herhangi bir sorunuz varsa veya yardıma ihtiyacınız olursa, kabin ekibimiz size yardımcı olmak için burada.",
        "nl": "Dames en heren, hier spreekt uw kapitein. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The temperature outside is {currentTemperature} degrees.] Ik hoop dat u tot nu toe van de vlucht geniet. Als u vragen heeft of hulp nodig heeft, staat ons cabinepersoneel klaar om te helpen.",
        "ko": "여러분, 기장입니다. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? '킬로미터' : '마일' %} per hour.] [The temperature outside is {currentTemperature} degrees.] 지금까지 비행을 즐기셨기를 바랍니다. 질문이 있거나 도움이 필요하시면 기내 승무원이 도와드리겠습니다.",
        "pt_pt": "Senhoras e senhores, aqui fala o capitão. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'quilómetros' : 'milhas' %} por hora.] [The temperature outside is {currentTemperature} degrees.] Espero que estejam a gostar da viagem até agora. Se tiverem alguma dúvida ou precisarem de assistência, a nossa tripulação está disponível para ajudar.",
        "no": "Mine damer og herrer, her taler kapteinen. [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'kilometer' : 'miles' %} per hour.] [The temperature outside is {currentTemperature} degrees.] Jeg håper du har hatt en god tur så langt. Hvis du har noen spørsmål eller trenger hjelp, er vårt kabinpersonell her for å hjelpe.",
        "th": "ท่านผู้โดยสารทุกท่าน นี่คือกัปตันของท่าน [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? 'กิโลเมตร' : 'ไมล์' %} ต่อชั่วโมง.] [The temperature outside is {currentTemperature} degrees.] หวังว่าคุณจะสนุกกับการเดินทางจนถึงตอนนี้ หากคุณมีคำถามหรือจำเป็นต้องได้รับความช่วยเหลือ โปรดอย่าลังเลที่จะถามพนักงานประจำเครื่อง",
        "zh": "各位乘客，您好！这是您的机长。 [We're currently flying near {currentPOIName}, visible on our {currentPOIDirection} side.] [At this moment, we’re cruising at an altitude of {currentAltitudeFt} feet and traveling at a speed of {groundSpeed} {% usesKMPH ? '公里' : '英里' %} 每小时.] [The temperature outside is {currentTemperature} degrees.] 我们希望您目前正在享受航程。如果您有任何问题或需要帮助，请随时向我们的机组人员寻求帮助。",
  ...
  },
  {
    ...
    "texts": [
      {
        "en": "Ladies and gentlemen, I'd like to share some information with you. We'll be flying over {currentPOIName} in a few moments. Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour. Temperature outside is {currentTemperature} degrees. Rest of the flight should be smooth. In case of any questions, please don't hesitate to ask one of our cabin crew members. Thank you and enjoy the flight.",
        "pl": "Szanowni Państwo, chciałbym przekazać garść informacji od siebie. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Reszta lotu powinna być spokojna. W razie pytań proszę zwrócić się do członków załogi. Dziękuję za uwagę i życzę miłego lotu.",
        "de": "Meine Damen und Herren, ich möchte einige Informationen mit Ihnen teilen. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'Kilometer' : 'Meilen' %} pro Stunde.] [Temperature outside is {currentTemperature} degrees.] Der Rest des Fluges sollte ruhig verlaufen. Bei Fragen wenden Sie sich bitte an einen unserer Crew-Mitglieder. Vielen Dank und genießen Sie den Flug.",
        "pt_br": "Senhoras e senhores, gostaria de compartilhar algumas informações com vocês. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'quilômetros' : 'milhas' %} por hora.] [Temperature outside is {currentTemperature} degrees.] O restante do voo deverá ser tranquilo. Caso tenha dúvidas, não hesite em perguntar a um dos nossos membros da tripulação. Obrigado e aproveite o voo.",
        "es": "Señoras y señores, me gustaría compartir algunas informaciones con ustedes. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilómetros' : 'millas' %} por hora.] [Temperature outside is {currentTemperature} degrees.] El resto del vuelo debería ser tranquilo. Si tiene alguna pregunta, no dude en preguntar a uno de nuestros miembros de la tripulación. Gracias y disfrute del vuelo.",
        "fr": "Mesdames et messieurs, j'aimerais partager quelques informations avec vous. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilomètres' : 'milles' %} par heure.] [Temperature outside is {currentTemperature} degrees.] Le reste du vol devrait être calme. En cas de questions, n'hésitez pas à demander à l'un de nos membres d'équipage. Merci et profitez du vol.",
        "it": "Signore e signori, vorrei condividere alcune informazioni con voi. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'chilometri' : 'miglia' %} all'ora.] [Temperature outside is {currentTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo. Se avete domande, non esitate a chiedere a uno dei nostri membri dell'equipaggio. Grazie e buon volo.",
        "tr": "Bayanlar ve baylar, sizlere bazı bilgileri paylaşmak istiyorum. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometre' : 'mil' %} saatte.] [Temperature outside is {currentTemperature} degrees.] Geriye kalan uçuş sorunsuz geçmelidir. Herhangi bir sorunuz olursa, lütfen kabin ekibimizin bir üyesine danışın. Teşekkür ederiz ve iyi uçuşlar.",
        "nl": "Dames en heren, ik zou graag enkele informatie met u willen delen. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] De rest van de vlucht zou rustig moeten verlopen. Als u vragen heeft, aarzel dan niet om een van onze cabinepersoneelleden te vragen. Dank u en geniet van de vlucht.",
        "ko": "여러분, 몇 가지 정보를 공유하고자 합니다. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? '킬로미터' : '마일' %} per hour.] [Temperature outside is {currentTemperature} degrees.] 비행 나머지 부분은 원활할 것입니다. 질문이 있으시면 주저하지 말고 기내 승무원에게 문의하십시오. 감사합니다. 즐거운 비행 되세요.",
        "pt_pt": "Senhoras e senhores, gostaria de partilhar algumas informações com vocês. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'quilómetros' : 'milhas' %} por hora.] [Temperature outside is {currentTemperature} degrees.] O resto do voo deverá ser tranquilo. Se tiver alguma dúvida, não hesite em perguntar a um dos nossos membros da tripulação. Obrigado e aproveite o voo.",
        "no": "Mine damer og herrer, jeg vil gjerne dele noen informasjoner med dere. [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'kilometer' : 'miles' %} per hour.] [Temperature outside is {currentTemperature} degrees.] Resten av flyturen skal være jevn. Hvis du har spørsmål, ikke nøl med å spørre en av kabinpersonalet. Takk og nyt flyreisen.",
        "th": "ท่านผู้โดยสารทุกท่าน ฉันขอแบ่งปันข้อมูลบางประการกับท่าน [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? 'กิโลเมตร' : 'ไมล์' %} ต่อชั่วโมง.] [Temperature outside is {currentTemperature} degrees.] ส่วนที่เหลือของเที่ยวบินควรจะราบรื่น หากท่านมีคำถาม โปรดอย่าลังเลที่จะถามเจ้าหน้าที่ประจำเครื่อง ขอบคุณและขอให้ท่านสนุกกับการเดินทาง",
        "zh": "各位乘客，您好！我想与您分享一些信息。 [We'll be flying over {currentPOIName} in a few moments.] [Our altitude is {currentAltitudeFt} feet and our speed is {groundSpeed} {% usesKMPH ? '公里' : '英里' %} 每小时.] [Temperature outside is {currentTemperature} degrees.] 剩下的航程应该会很平稳。如果您有任何问题，请随时向我们的机组人员咨询。感谢您乘坐{airlineName}航空公司的航班。",
      ...
      },
      {
        ...
        "es": "Hola a todos. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] En caso de dudas, estamos aquí para ayudar. Gracias por volar con nosotros.",
        "fr": "Bonjour à tous. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] En cas de questions, nous sommes là pour vous aider. Merci de voler avec nous.",
        "it": "Ciao a tutti. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] In caso di domande, siamo qui per aiutarvi. Grazie per volare con noi.",
        "tr": "Herkese merhaba. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] Sorularınız varsa, size yardımcı olmak için buradayız. Bizimle uçtuğunuz için teşekkür ederiz.",
        "nl": "Hallo iedereen. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] Als u vragen heeft, staan we voor u klaar. Bedankt dat u met ons vliegt.",
        "ko": "여러분, 안녕하세요. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] 질문이 있으시면 언제든지 도와드리겠습니다. 우리와 함께 비행해 주셔서 감사합니다.",
        "pt_pt": "Olá a todos. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'quilómetros' : 'milhas' %} por hora.] [The outside temperature is {currentTemperature} graus.] Em caso de dúvidas, estamos à disposição. Obrigado por voar connosco.",
        "no": "Hei alle sammen. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'kilometer' : 'miles' %} per hour.] [The outside temperature is {currentTemperature} degrees.] Hvis du har noen spørsmål, er vi her for å hjelpe. Takk for at du fløy med oss.",
        "th": "สวัสดีทุกคน. [Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? 'กิโลเมตร' : 'ไมล์' %} ต่อชั่วโมง.] [The outside temperature is {currentTemperature} degrees.] หากท่านมีคำถาม เราพร้อมที่จะช่วยเสมอ ขอบคุณที่บินกับเรา.",
        "zh": "大家好。[Just to keep you updated, we’re about to fly over {currentPOIName}.] [We’re maintaining a steady altitude of {currentAltitudeFt} feet and traveling at {groundSpeed} {% usesKMPH ? '公里' : '英里' %} 每小时.] [The outside temperature is {currentTemperature} degrees.] 如有任何问题，我们随时为您提供帮助。感谢您与我们一同飞行。",
    ...
    "texts": [
      {
        ...
        "de": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und folgen Sie den Anweisungen der Besatzung. Vielen Dank.",
        "pt_br": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Por favor, certifique-se de que seu cinto de segurança está afivelado e siga as instruções da tripulação. Obrigado.",
        "es": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Por favor, asegúrese de que su cinturón de seguridad esté abrochado y siga las instrucciones de la tripulación. Gracias.",
        "fr": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Merci de vous assurer que votre ceinture de sécurité est attachée et de suivre les instructions de l'équipage. Merci.",
        "it": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Si prega di assicurarsi che la cintura di sicurezza sia allacciata e di seguire le istruzioni dell'equipaggio. Grazie.",
        "tr": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Lütfen emniyet kemerinizin bağlı olduğundan emin olun ve kabin ekibinin talimatlarına uyun. Teşekkür ederiz.",
        "nl": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Zorg ervoor dat uw veiligheidsgordel vastzit en volg de instructies van de cabinebemanning. Dank u.",
        "ko": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] 안전벨트가 착용되어 있는지 확인하시고 기내 승무원의 지시에 따르시기 바랍니다. 감사합니다.",
        "pt_pt": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Por favor, certifique-se de que o seu cinto de segurança está apertado e siga as instruções da tripulação. Obrigado.",
        "no": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] Vennligst sørg for at sikkerhetsbeltet er festet og følg besetningens instruksjoner. Takk.",
        "th": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] โปรดตรวจสอบให้แน่ใจว่าเข็มขัดนิรภัยของท่านถูกล็อกและปฏิบัติตามคำแนะนำของลูกเรือ ขอบคุณค่ะ.",
        "zh": "[Ladies and gentlemen, we’ll be starting our descent into {destinationCityName} shortly.] 请确保系好安全带，并按照机组人员的指示操作。谢谢。",
      ...
      },
      {
        ...
        "de": "Meine Damen und Herren, wir beginnen in wenigen Minuten mit dem Sinkflug. Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und folgen Sie den Anweisungen der Besatzung. Vielen Dank.",
        "pt_br": "Senhoras e senhores, começaremos a descida em alguns minutos. Por favor, certifique-se de que seu cinto de segurança está afivelado e siga as instruções da tripulação. Obrigado.",
        "es": "Damas y caballeros, comenzaremos nuestro descenso en unos minutos. Por favor, asegúrese de que su cinturón de seguridad esté abrochado y siga las instrucciones de la tripulación. Gracias.",
        "fr": "Mesdames et messieurs, nous commencerons notre descente dans quelques minutes. Veuillez vous assurer que votre ceinture de sécurité est attachée et suivez les instructions de l'équipage. Merci.",
        "it": "Signore e signori, inizieremo la discesa tra pochi minuti. Si prega di assicurarsi che la cintura di sicurezza sia allacciata e di seguire le istruzioni dell'equipaggio. Grazie.",
        "tr": "Bayanlar ve baylar, birkaç dakika içinde alçalmaya başlayacağız. Lütfen emniyet kemerinizin bağlı olduğundan emin olun ve kabin ekibinin talimatlarına uyun. Teşekkür ederiz.",
        "nl": "Dames en heren, we zullen over een paar minuten beginnen met dalen. Zorg ervoor dat uw veiligheidsgordel vastzit en volg de instructies van de cabinebemanning. Dank u.",
        "ko": "여러분, 몇 분 후에 하강을 시작하겠습니다. 안전벨트가 착용되어 있는지 확인하시고 기내 승무원의 지시에 따르시기 바랍니다. 감사합니다.",
        "pt_pt": "Senhoras e senhores, começaremos a descida em alguns minutos. Por favor, certifique-se de que o seu cinto de segurança está apertado e siga as instruções da tripulação. Obrigado.",
        "no": "Mine damer og herrer, vi vil starte nedstigningen om noen minutter. Vennligst sørg for at sikkerhetsbeltet er festet og følg besetningens instruksjoner. Takk.",
        "th": "ท่านผู้โดยสารทุกท่าน เราจะเริ่มลดระดับในไม่ช้า โปรดตรวจสอบให้แน่ใจว่าเข็มขัดนิรภัยของท่านถูกล็อกและปฏิบัติตามคำแนะนำของลูกเรือ ขอบคุณค่ะ.",
        "zh": "各位乘客，我们将在几分钟后开始下降。请确保系好安全带，并按照机组人员的指示操作。谢谢。",
    ...
    "texts": [
      {
        ...
        "zh": "[Ladies and gentlemen, welcome to {destinationCityName}.] [The time is currently {localTimeHours} {localTimeMinutes}.] [We have {currentTemperature} degrees outside.]  请保持系好安全带并坐在座位上，直到飞机完全停稳且安全带标志熄灭。请在下飞机前确保携带好您的所有随身物品。代表全体机组人员，感谢您今天选择与我们一起飞行。我们希望您度过了一个愉快的旅程，并期待再次欢迎您登机。",
      ...
      },
      {
        ...
        "pl": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Prosimy o pozostanie na miejscach z zapiętymi pasami bezpieczeństwa, aż samolot całkowicie się zatrzyma i sygnał zapięcia pasów zostanie wyłączony. Upewnijcie się, że macie ze sobą wszystkie swoje rzeczy osobiste przed opuszczeniem samolotu. Dziękuję za lot z nami w dniu dzisiejszym. Mamy nadzieję, że mieli państwo przyjemny lot i mamy nadzieję gościć państwa ponownie w najbliższej przyszłości.",
        "de": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Bitte bleiben Sie mit angelegtem Sicherheitsgurt sitzen, bis das Flugzeug vollständig zum Stillstand gekommen und das Anschnallzeichen ausgeschaltet ist. Bitte stellen Sie sicher, dass Sie alle Ihre persönlichen Gegenstände bei sich haben, bevor Sie das Flugzeug verlassen. Im Namen der Crew möchte ich Ihnen dafür danken, dass Sie heute mit uns geflogen sind. Wir hoffen, Sie hatten einen angenehmen Flug und freuen uns, Sie bald wieder an Bord begrüßen zu dürfen.",
        "pt_br": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Por favor, permaneça sentado com o cinto de segurança afivelado até que a aeronave pare completamente e o aviso de atar os cintos seja apagado. Certifique-se de ter todos os seus pertences pessoais com você antes de sair da aeronave. Em nome da tripulação, gostaria de agradecer por voar conosco hoje. Esperamos que você tenha tido um voo agradável e esperamos recebê-lo novamente a bordo em breve.",
        "es": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Permanezca sentado con el cinturón de seguridad abrochado hasta que el avión se detenga por completo y se apague la señal de cinturón de seguridad. Asegúrese de tener todas sus pertenencias personales consigo antes de abandonar el avión. En nombre de la tripulación, me gustaría agradecerle por volar con nosotros hoy. Esperamos que haya tenido un vuelo agradable y esperamos darle la bienvenida a bordo nuevamente pronto.",
        "fr": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Veuillez rester assis avec votre ceinture de sécurité attachée jusqu'à ce que l'avion soit complètement arrêté et que le signal de ceinture soit éteint. Assurez-vous de prendre tous vos effets personnels avec vous avant de quitter l'avion. Au nom de l'équipage, je vous remercie d'avoir volé avec nous aujourd'hui. Nous espérons que vous avez passé un agréable vol et nous serons ravis de vous accueillir à nouveau très bientôt.",
        "it": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Vi preghiamo di rimanere seduti con la cintura di sicurezza allacciata fino a quando l'aereo sarà completamente fermo e il segnale della cintura sarà spento. Prima di lasciare l’aereo, assicuratevi di avere con voi tutti i vostri effetti personali. A nome dell’equipaggio, vi ringraziamo per aver volato con noi oggi. Speriamo che abbiate avuto un volo piacevole e non vediamo l’ora di accogliervi di nuovo a bordo presto.",
        "tr": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Uçak tamamen durana ve emniyet kemeri işareti kapatılana kadar lütfen emniyet kemeriniz bağlı olarak yerinizde kalın. Lütfen uçaktan ayrılmadan önce tüm kişisel eşyalarınızın yanınızda olduğundan emin olun. Mürettebat adına bugün bizimle uçtuğunuz için teşekkür etmek istiyorum. Keyifli bir uçuş geçirdiğinizi umar, sizi en kısa zamanda tekrar gemimizde ağırlamayı sabırsızlıkla bekliyoruz.",
        "nl": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Blijft u alstublieft zitten met uw veiligheidsgordel om totdat het vliegtuig volledig tot stilstand is gekomen en het stoelriemen vast teken is uitgeschakeld. Zorg ervoor dat u al uw persoonlijke bezittingen bij u heeft voordat u het toestel verlaat. Namens de bemanning wil ik u bedanken voor het vliegen met ons vandaag. We hopen dat u een prettige vlucht heeft gehad en verwelkomen u graag binnenkort weer aan boord.",
        "ko": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] 비행기가 완전히 정지하고 좌석벨트 싸인이 꺼질 때까지 좌석벨트를 매고 앉아 계십시오. 항공기를 떠나기 전에 잊으신 물건은 없는지 확인하시기 바랍니다. 승무원을 대표하여 오늘 저희와 함께 비행해 주셔서 감사합니다. 즐거운 비행이 되었기를 바라며 곧 기내에서 다시 만날 수 있기를 기대합니다.",
        "pt_pt": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Por favor, permaneçam sentados com o cinto de segurança apertado até que a aeronave esteja completamente parada e o sinal de apertar os cintos seja desligado. Certifiquem-se de que têm todos os vossos pertences pessoais convosco antes de deixarem a aeronave. Em nome da tripulação, gostaria de vos agradecer por voarem connosco hoje. Esperamos que tenham tido um voo agradável e esperamos recebê-los a bordo novamente em breve.",
        "no": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] Vennligst forbli sittende med sikkerhetsbeltet festet til flyet har kommet til full stopp og fest-sikkerhetsbelteskiltet er slått av. Sørg for at dere har alle personlige eiendeler med dere før dere forlater flyet. På vegne av mannskapet vil jeg takke dere for at dere fløy med oss i dag. Vi håper dere har hatt en behagelig flytur, og vi ser frem til å ønske dere velkommen om bord igjen snart.",
        ...
        "zh": "[Welcome to {destinationCityName}.] [Temperature outside is {currentTemperature} degrees.] [Current local time is {localTimeMinutes} minutes past {localTimeHours}.] 请保持系好安全带并坐在座位上，直到飞机完全停稳且安全带标志熄灭。请在下飞机前确保携带好您的所有随身物品。代表全体机组人员，感谢您今天选择与我们一起飞行。我们希望您度过了一个愉快的旅程，并期待再次欢迎您登机。",
