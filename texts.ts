...
const texts: Text[] = [
  ...
  // Pre-flight
  {
    ...
    "texts": [
      ...
      {
        "en": "{% ['Good morning', 'Good afternoon', 'Good evening'][dayStage]='Hello' %}, this is your captain speaking. Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}. We are currently preparing for departure and we will be taking off shortly. Thank you for choosing to fly with us today.",
        "pl": "{% ['Dzień dobry', 'Dzień dobry', 'Dobry wieczór'][dayStage]='Dzień dobry' %}, tu kapitan. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Obecnie przygotowujemy się do startu i wkrótce rozpoczniemy kołowanie. Dziękujemy za wybór naszego przewoźnika.",
        "de": "{% ['Guten Abend', 'Guten Tag', 'Guten Abend'][dayStage]='Hello' %}, hier spricht Ihr Kapitän. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Vielen Dank, dass Sie sich entschieden haben, heute mit uns zu fliegen.",
        "pt_br": "{% ['Bom dia', 'Boa tarde', 'Boa noite'][dayStage]='Olá' %} aqui é o comandante falando. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] No momento estamos nos preparando para a partida e decolaremos em breve. Obrigado por escolher voar conosco hoje.",
        "es": "{% ['Buenos días', 'Buenas tardes', 'Buenas noches'][dayStage]='Hola' %}, este es el capitán. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Actualmente nos estamos preparando para el despegue y pronto comenzaremos a rodar. Gracias por elegir nuestro transportista.",
        "fr": "{% ['Bonjour', 'Bonjour', 'Bonsoir'][dayStage]='Bonjour' %}, ici votre commandant de bord. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Nous sommes en train de finaliser les préparatifs pour le départ et nous allons bientôt nous envoler. Merci d'avoir choisi de voyager avec nous aujourd'hui.",
        "it": "{% ['Buongiorno', 'Buon pomeriggio', 'Buonasera'][dayStage]='Buongiorno' %}, parla il vostro commandante. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Stiamo finendo i preparativi per la partenza e decolleremo a breve. Grazie per aver scelto di volare con noi.",
        "tr": "{% ['Günaydın', 'İyi günler', 'İyi akşamlar'][dayStage]='Merhaba' %}, kaptanınız konuşuyor. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Şu anda kalkışa hazırlanıyoruz ve kısa süre sonra yola çıkacağız. Bugün bizimle uçmayı seçtiğiniz için teşekkür ederiz.",
        "nl": "{% ['Goedemorgen', 'Goedemiddag', 'Goedenavond'][dayStage]='Hallo' %}, hier spreekt uw gezagvoerder. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Wij bereiden ons momenteel voor op vertrek en zullen binnenkort opstijgen. Bedankt dat u heeft gekozen om vandaag met ons te vliegen.",
        ...
        "no": "{% ['God morgen', 'God ettermiddag', 'God kveld'][dayStage]='Hei' %}, dette er kapteinen som snakker. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Vi er for øyeblikket i ferd med å forberede oss til avgang, og forventer å sette i gang straks. Takk for at dere valgte å fly med oss i dag.",
