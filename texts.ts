...
const texts: Text[] = [
  ...
  // Pre-flight
  {
    ...
    "texts": [
      ...
      {
        "en": "{% ['Good morning', 'Good afternoon', 'Good evening'][departureDayPhase]='Hello' %}, this is your captain speaking. Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}. We are currently preparing for departure and we will be taking off shortly. Thank you for choosing to fly with us today.",
        "pl": "{% ['Dzień dobry', 'Dzień dobry', 'Dobry wieczór'][departureDayPhase]='Dzień dobry' %}, tu kapitan. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Obecnie przygotowujemy się do startu i wkrótce rozpoczniemy kołowanie. Dziękujemy za wybór naszego przewoźnika.",
        "de": "{% ['Guten Abend', 'Guten Tag', 'Guten Abend'][departureDayPhase]='Hello' %}, hier spricht Ihr Kapitän. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Vielen Dank, dass Sie sich entschieden haben, heute mit uns zu fliegen.",
        "pt_br": "{% ['Bom dia', 'Boa tarde', 'Boa noite'][departureDayPhase]='Olá' %} aqui é o comandante falando. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] No momento estamos nos preparando para a partida e decolaremos em breve. Obrigado por escolher voar conosco hoje.",
        "es": "{% ['Buenos días', 'Buenas tardes', 'Buenas noches'][departureDayPhase]='Hola' %}, este es el capitán. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Actualmente nos estamos preparando para el despegue y pronto comenzaremos a rodar. Gracias por elegir nuestro transportista.",
        ...
        "tr": "{% ['Günaydın', 'İyi günler', 'İyi akşamlar'][departureDayPhase]='Merhaba' %}, kaptanınız konuşuyor. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Şu anda kalkışa hazırlanıyoruz ve kısa süre sonra yola çıkacağız. Bugün bizimle uçmayı seçtiğiniz için teşekkür ederiz.",
        "nl": "{% ['Goedemorgen', 'Goedemiddag', 'Goedenavond'][departureDayPhase]='Hallo' %}, hier spreekt uw gezagvoerder. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Wij bereiden ons momenteel voor op vertrek en zullen binnenkort opstijgen. Bedankt dat u heeft gekozen om vandaag met ons te vliegen.",
        ...
        "pt_pt": "Caros passageiros, fala o vosso comandante. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Estamos atualmente a preparar-nos para a descolagem e partiremos em breve. Obrigado por terem escolhido voar connosco hoje.",
        "no": "{% ['God morgen', 'God ettermiddag', 'God kveld'][departureDayPhase]='Hei' %}, dette er kapteinen som snakker. [Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] Vi er for øyeblikket i ferd med å forberede oss til avgang, og forventer å sette i gang straks. Takk for at dere valgte å fly med oss i dag.",
        ...
        "zh": "女士们，先生们，我是您的机长。[Welcome aboard on this {% isShortHaul ? 'short' : '' %} {airlineName} flight number {flightNumber} from {originCityName} to {destinationCityName}.] 我们正在准备起飞，稍后即将起飞。感谢您今天选择与我们一同飞行。"
      },
      {
    ...
    "texts": [
      {
        ...
        "fr": "Mesdames et messieurs, ici le commandant de bord. J'aimerais vous partager quelques informations sur notre vol. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Le reste du vol devrait être calme, avec une faible possibilité de légères turbulences. Merci de garder votre ceinture de sécurité attachée pendant que vous êtes assis et chaque fois que le signal de ceinture est allumé. Merci et bon vol.",
        "it": "Signore e signori, parla il vostro comandante. Vorrei darvi alcune informazioni. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo, con una piccola possibilità di leggere turbolenze. Vi preghiamo di tenere sempre la cintura di sicurezza allacciata mentre siete seduti e ogni volta che il segnale della cintura è acceso. Grazie e buon volo.",
        "tr": "Bayanlar ve baylar, kaptanınız konuşuyor. Sizinle bazı bilgileri paylaşayım. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Uçuşun geri kalanı, hafif türbülansların az da olsa yaşanması ihtimaliyle birlikte sorunsuz geçmelidir. Lütfen oturduğunuzda ve emniyet kemeri işareti yandığında emniyet kemerinizi bağlı tutmayı unutmayın. Teşekkür ederim ve uçuşun tadını çıkarın.",
        "nl": "Dames en heren, hier spreekt uw gezagvoerder. Ik wil graag wat informatie met u delen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] De rest van de vlucht zou vlot moeten verlopen, met een kleine kans op lichte turbulentie. Vergeet niet uw veiligheidsgordel te dragen wanneer u zit en wanneer het stoelriemen vast teken is geactiveerd. Bedankt en geniet van uw vlucht.",
        "ko": "승객 여러분, 기장입니다. 몇 가지 정보를 여러분과 공유하겠습니다. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] {destinationCityName}의 날씨는 {destinationCityWheatherHumanDescription}이며 온도는 {destinationCityTemperature}도입니다. 앞으로 난기류가 발생할 가능성이 적으며 순조로운 비행이 될 것으로 보입니다. 자리에 앉아 좌석벨트 싸인에 불이 켜질 때마다 좌석벨트 착용하는 것을 기억하시기 바랍니다. 감사합니다, 즐거운 비행 되세요.",
        "pt_pt": "Senhoras e senhores, fala o vosso comandante. Deixem-me partilhar algumas informações convosco. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O resto do voo deverá ser tranquilo, com uma pequena possibilidade de ligeiras turbulências. Por favor, lembrem-se de manter o cinto de segurança apertado enquanto estiverem sentados e sempre que o sinal de apertar os cintos estiver iluminado. Obrigado e desfrutem do voo.",
        "no": "Mine damer og herrer, dette er kapteinen som snakker. La meg dele litt informasjon med dere. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Resten av flyturen bør bli jevn, med liten sjanse for lett turbulens. Vennligst husk å holde sikkerhetsbeltet festet mens dere sitter, og alltid når skiltet med fest-sikkerhetsbeltet er tent. Takk, og nyt flyturen.",
        ...
        "zh": "女士们，先生们，我是您的机长。让我与您分享一些信息。[We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] 接下来的飞行应该会非常平稳，仅有轻微颠簸的可能。请记得在座位上系好安全带，并在安全带标志亮起时保持系好状态。谢谢，祝您飞行愉快。"
      },
      {
        ...
        "pl": "Proszę Państwa, tu kapitan. Chciałem podzielić się z wami kilkoma informacjami. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Reszta lotu powinna być spokojna. W przypadku pytań, proszę zwrócić się do jednego z członków naszej załogi. Dziękuję i miłego lotu.",
        "de": "Hallo, ich bin es wieder. Ich möchte ein paar Informationen mit Ihnen teilen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Der Rest des Fluges sollte ruhig verlaufen. Bei Fragen wenden Sie sich bitte an eines unserer Kabinenpersonalmitglieder. Danke und genießen Sie den Flug.",
        "pt_br": "Olá, sou eu de novo. Eu gostaria de compartilhar algumas informações com vocês. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O restante do voo deve ser tranquilo. Em caso de dúvidas, não hesite em perguntar a um dos nossos comissários. Obrigado e aproveite o vôo.",
        ...
        "fr": "Bonjour, c’est votre commandant de bord. Je voulais juste partager quelques informations avec vous. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Le reste du vol devrait être calme. Si vous avez des questions, n'hésitez pas à demander à l'un de nos membres d'équipage. Merci et bon vol.",
        "it": "Signore e signori, è il vostro comandante che vi parla. Volevo condividere alcune informazioni sul nostro volo. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo. Se avete domande, non esitate a chiedere a uno dei membri dell’equipaggio. Grazie e buon volo.",
        "tr": "Merhaba, yine ben. Sadece sizinle bazı bilgileri paylaşmak istedim. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Uçuşun geri kalanı sorunsuz olmalı. Herhangi bir sorunuz olması durumunda lütfen kabin ekibimizden birine sormaktan çekinmeyin. Teşekkür ederim ve uçuşun tadını çıkarın.",
        "nl": "Hallo, ik ben het weer. Ik wil graag wat informatie met u delen. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] De rest van de vlucht zou vlot moeten verlopen. Als u vragen heeft, stel ze dan gerust aan het cabinepersoneel. Bedankt en geniet van uw vlucht.",
        "ko": "안녕하세요. 또 저예요. 여러분과 정보를 나누고 싶어서요. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] {destinationCityName}의 날씨는 {destinationCityWeatherHumanDescription}이며 온도는 {destinationCityTemperature}도입니다. 남은 비행은 순조로울 것으로 보입니다. 궁금한 점이 있으시면 주저하지 말고 객실 승무원에게 물어보세요. 감사합니다. 즐거운 비행 되세요.",
        ...
        "no": "Hei, det er meg igjen. Jeg ville bare dele litt informasjon med dere. [We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Resten av flyturen bør bli jevn. Hvis dere har spørsmål, ikke nøl med å spørre en av våre kabinansatte. Takk, og nyt flyturen.",
        ...
        "zh": "大家好，又是我。我想与您分享一些信息。[We are currently cruising at an altitude of {currentAltitudeFt} feet at an speed of {groundSpeed} {% usesKMPH ? 'kilometers' : 'miles' %} per hour.] [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] 接下来的飞行应该会非常平稳。如果有任何问题，请随时向我们的机组人员提出。谢谢，祝您飞行愉快。"
      }
    ]
  },
  {
