  ...
  // Pre-flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "fr": "Bonjour, ici votre commandant de bord. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Nous sommes en train de finaliser les préparatifs pour le départ et nous allons bientôt nous envoler. Merci d'avoir choisi de voyager avec nous aujourd'hui.",
        "it": "Buongiorno, parla il vostro commandante. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] Stiamo finendo i preparativi per la partenza e decolleremo a breve. Grazie per aver scelto di volare con noi.",
  ...
  // Basic information about the flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "fr": "Mesdames et messieurs, ici le commandant de bord. La durée de notre vol aujourd'hui sera d'environ {flightTime}. Le temps à {destinationCityName} est {destinationCityWeatherHumanDescription}. Nous prévoyons un vol calme avec une faible possibilité de légères turbulences. Detendez-vous et profiter du vol.",
    ...
    "texts": [
      {
        ...
        "fr": "Mesdames et messieurs, ici le commandant de bord. J'aimerais vous partager quelques informations sur notre vol. Nous sommes actuellement en croisière à une altitude de {currentAltitudeFt} pieds et à une vitesse de {groundSpeedKm} kilomètres par heure. Le temps à {destinationCityName} est {destinationCityWeatherHumanDescription}, avec une température de {destinationCityTemperature} degrés. Le reste du vol devrait être calme, avec une faible possibilité de légères turbulences. Merci de garder votre ceinture de sécurité attachée pendant que vous êtes assis et chaque fois que le signal de ceinture est allumé. Merci et bon vol.",
        "it": "Signore e signori, parla il vostro comandante. Vorrei darvi alcune informazioni. Attualmente stiamo volando a un’altitudine di {currentAltitudeFt} piedi a una velocità di {groundSpeedKm} chilometri all’ora. Il tempo a {destinationCityName} è {destinationCityWeatherHumanDescription}, con una temperatura di {destinationCityTemperature} gradi. Il resto del volo dovrebbe essere tranquillo, con una piccola possibilità di leggere turbolenze. Vi preghiamo di tenere sempre la cintura di sicurezza allacciata mentre siete seduti e ogni volta che il segnale della cintura è acceso. Grazie e buon volo.",
      ...
      },
      {
        ...
        "it": "Signore e signori, è il vostro comandante che vi parla. Volevo condividere alcune informazioni sul nostro volo. Attualmente stiamo volando a un’altitudine di {currentAltitudeFt} piedi e a una velocità di {groundSpeedKm} chilometri all’ora. Il tempo a {destinationCityName} è {destinationCityWeatherHumanDescription}, con una temperatura di {destinationCityTemperature} gradi. Il resto del volo dovrebbe essere tranquillo. Se avete domande, non esitate a chiedere a uno dei membri dell’equipaggio. Grazie e buon volo.",
