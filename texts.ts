    ...
    "texts": [
      {
        ...
        "ko": "{originCityName}에서 {destinationCityName}까지 가는 {airlineName} 항공편에 탑승하신 것을 환영합니다. 저는 {captainName}이고 이 항공편의 기장입니다. 여러분의 탑승을 환영하고 오늘 저희 비행기를 이용해 주셔서 감사의 말씀을 드립니다. 승무원들은 현재 출발을 준비하고 있으며 곧 이륙할 예정입니다. 오늘 저희 항공편은 약 {flightTime} 정도 소요될 예정입니다. 질문이 있거나 도움이 필요한 경우 주저하지 마시고 객실 승무원 중 한명에게 문의해 주시기 바랍니다. 저희와 함께 해주셔서 감사합니다."
      },
      {
        ...
        "ko": "승객 여러분, {originCityName}에서 {destinationCityName}까지 가는 {airlineName} 항공편에 탑승하신 것을 환영합니다. 제 이름은 {captainName}이고 이 항공편의 기장입니다. 현재 출발 준비 중이며 곧 이륙할 예정입니다. {airlineName} 비행편을 선택해 주셔서 감사합니다. 즐거운 비행 되세요."
      },
      {
        ...
        "ko": "안녕하세요, 기장님입니다. {originCityName}에서 {destinationCityName}까지 가는 {airlineName} 항공편에 탑승하신 것을 환영합니다. 현재 출발 준비 중이며 곧 이륙할 예정입니다. 오늘 저희 비행기를 이용해 주셔서 감사합니다."
      }
    ]
  },
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "ko": "승객 여러분, 탑승을 환영합니다. 제 이름은 {crewName}이고 이 비행기의 객실 승무원입니다. 자리에 앉으셔서 좌석벨트를 매시고 좌석 아래 또는 머리 위 칸의 모든 수하물을 고정해 주시기 바랍니다. 또한 이륙을 위해 좌석과 앞좌석 선반이 똑바로 접혀있는지 확인해주시고 노트북과 휴대전화를 포함한 모든 개인 전자 기기의 전원을 꺼주시기 바랍니다. 비행 중에는 흡연이 금지되어 있습니다. {airlineName} 항공편을 선택해 주셔서 감사합니다. 즐거운 비행 되세요."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ko": "{airlineName} 항공편에 탑승하신 것을 환영합니다. 오늘 저희는 {originCityName}에서 {destinationCityName}까지 비행합니다. 제 이름은 {crewName}이고 이 항공편의 객실 승무원입니다. 현재 출발을 준비하고 있으며 곧 이륙할 예정입니다. 좌석벨트가 잘 매여 있고 좌석 등받이와 앞좌석 선반이 똑바로 접혀있는지 확인하십시오. 질문이 있거나 도움이 필요하면 주저하지 말고 객실 승무원에게 물어보세요. {airlineName} 항공편을 이용해 주셔서 감사합니다."
      },
      {
        ...
        "ko": "승객 여러분, {originCityName}에서 {destinationCityName}까지 가는 {airlineName} 항공편에 탑승하신 것을 환영합니다. 저는 이 항공편의 객실 승무원입니다. 자리에 앉아서 좌석벨트를 매시고 좌석 아래 또는 머리 위칸에 모든 수하물을 고정해 주시기 바랍니다. 또한 이륙을 위해 좌석과 앞좌석 선반이 똑바로 접혀있는지 확인해주세요. 노트북과 휴대전화를 포함한 모든 개인 전자 기기의 전원을 꺼주시기 바랍니다. 비행 중에는 흡연이 금지되어 있습니다. {airlineName} 항공편을 선택해 주셔서 감사합니다. 즐거운 비행 되세요."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ko": "오늘 저희 항공편은 비행에 {flightTime} 정도 소요될 예정입니다. {destinationCityName}의 날씨는 {destinationCityWeatherHumanDescription}입니다. 자리에 앉아 좌석벨트 싸인에 불이 켜질 때마다 좌석벨트 착용 하는것을 잊지마세요."
      },
      {
        ...
        "ko": "안녕하세요. 다시 기장입니다. 승객 여러분들에게 몇가지 정보를 알려드릴까 합니다. 오늘 우리 비행기는 비행에 대략 {flightTime} 정도 걸릴 것으로 보입니다. {destinationCityName}의 날씨는 {destinationCityWeatherHumanDescription}입니다. 가벼운 난기류가 발생할 가능성은 있지만 순조로운 비행을 예상하고 있습니다. 긴장을 풀고 비행을 즐기시기 바랍니다."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ko": "오늘 저희 비행기는 비행시간이 {flightTime}정도 소요될 예정입니다. 기장님께서 비행이 원활해야 한다고 알려주셨습니다. 이륙 직후 간식과 음료 서비스를 시작하겠습니다. 앞 좌석 주머니에서 스카이 메뉴를 찾을 수 있습니다."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ko": "승객 여러분, 저희는 {destinationCityName}으로 하강을 시작합니다. 착륙을 준비하는 동안 객실 승무원의 지시에 따라 주시기 바랍니다. 감사합니다."
      },
      {
    ...
    "texts": [
      {
        ...
        "ko": "승객 여러분, 기장님의 말씀대로 {destinationCityName}으로 하강을 시작합니다. 좌석벨트를 매고 좌석 등받이와 앞좌석 선반이 똑바로 접혀있는지 확인하십시오. 몇 분안에 남은 서비스 물품을 수거하겠습니다. 감사합니다."
      },
      {
    ...
    "texts": [
      {
        ...
        "ko": "승객 여러분, 저희는 {destinationCityName}으로 하강을 시작합니다. 좌석벨트가 매여 있고 좌석 등받이와 앞좌석 선반이 똑바로 접혀있는지 확인하십시오. 몇 분 후에 남은 서비스 항목을 수거하겠습니다. 감사합니다."
      },
      {
    ...
    "texts": [
      {
        ...
        "ko": "승객 여러분, {destinationCityName}에 오신 것을 환영합니다. 비행기가 완전히 정지하고 좌석벨트 싸인이 꺼질 때까지 좌석벨트를 매고 앉아 계십시오. 비행기를 떠나기 전에 잊으신 물건은 없는지 확인하시기 바랍니다. 승무원을 대표하여 오늘 저희와 함께 비행해 주셔서 감사드립니다. 즐거운 비행이 되셨기를 바라며 다시 만날 수 있기를 기대합니다."
      },
      {
        ...
        "ko": "{destinationCityName}에 오신 것을 환영합니다. 비행기가 완전히 정지하고 좌석벨트 싸인이 꺼질 때까지 좌석벨트를 매고 앉아 계십시오. 항공기를 떠나기 전에 잊으신 물건은 없는지 확인하시기 바랍니다. 승무원을 대표하여 오늘 저희와 함께 비행해 주셔서 감사합니다. 즐거운 비행이 되었기를 바라며 곧 기내에서 다시 만날 수 있기를 기대합니다."
      }
    ]
  },
