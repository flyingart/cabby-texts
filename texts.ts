  ...
  // Pre-flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "pt_br": "Olá pessoal aqui é o comandante falando. [Welcome aboard on this {airlineName} flight from {originCityName} to {destinationCityName}.] No momento estamos nos preparando para a partida e decolaremos em breve. Obrigado por escolher voar conosco hoje.",
  ...
  // Random information about the flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "pt_br": "Olá, sou eu de novo. Eu gostaria de compartilhar algumas informações com vocês. No momento, estamos navegando a uma altitude de {currentAltitudeFt} pés a uma velocidade de {groundSpeedKm} quilômetros por hora. [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] O restante do voo deve ser tranquilo. Em caso de dúvidas, não hesite em perguntar a um dos nossos comissários. Obrigado e aproveite o vôo.",
        ...
        "it": "Signore e signori, è il vostro comandante che vi parla. Volevo condividere alcune informazioni sul nostro volo. Attualmente stiamo volando a un’altitudine di {currentAltitudeFt} piedi e a una velocità di {groundSpeedKm} chilometri all’ora. [The weather in {destinationCityName} is {destinationCityWeatherHumanDescription}, with a temperature of {destinationCityTemperature} degrees.] Il resto del volo dovrebbe essere tranquillo. Se avete domande, non esitate a chiedere a uno dei membri dell’equipaggio. Grazie e buon volo.",
